            ...
            if (apply_filters('sharing_email_check', true, $post, $post_data)) {
                ...
                if ($ajax) {
                    ...
                    <div class="response">
                        ...
                        <div
                            class="response-sub"><?php printf(__('You have shared this post with %s', 'jetpack'), esc_html($target_email)); ?></div>
                        <div class="response-close"><a href="#"
                                                       class="sharing_cancel"><?php _e('Close', 'jetpack'); ?></a></div>
                    </div>
                    <?php
                } else
        ...
        <div id="sharing_email" style="display: none;">
            <form action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post">
                ...
                <?php if (is_user_logged_in()) : ?>
                    ...
                    <input type="hidden" name="source_email"
                ...
                <?php endif; ?>
                <input type="text" id="jetpack-source_f_name" name="source_f_name" class="input" value="" size="25"
                       autocomplete="off"/>
                ...
                echo apply_filters('jetpack_static_url', plugin_dir_url(__FILE__) . 'images/loading.gif'); ?>"
    ...
    public function display_footer()
    {
        ...
        if ($this->smart) {
            ...
            <script>(function (d, s, id) {
                    ...
                    js = d.createElement(s);
                    js.id = id;
                    js.src = '//connect.facebook.net/<?php echo $locale; ?>/sdk.js#xfbml=1<?php echo $fb_app_id; ?>&version=v2.3';
                    fjs.parentNode.insertBefore(js, fjs);
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="remove">
                            <small><?php _e('Remove Service', 'jetpack'); ?></small>
                        </a>
                    </td>
                </tr>
                </tbody>
    ...
    public function display_footer()
    {
        ...
        <script type="text/javascript">
            ...
            jQuery(window).load(function () {
                jQuery('li.share-pinterest a span:visible').closest('.share-pinterest').width('80px');
            });
        </script>
