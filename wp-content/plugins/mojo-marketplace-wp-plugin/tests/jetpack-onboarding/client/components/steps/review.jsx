        ...
        return (
            <WelcomeSection id="welcome__review">
                <div className="welcome__dismiss">
                    <a href="#" onClick={ this.handleDismiss }><Dashicon name="dismiss"/><span
                        className='screen-reader-text'>Dismiss</span></a></div>
                ...
                <div className="welcome__review-cols">
                    <div className="welcome__review-col">
                        <ul className="welcome__review-list">
                            <li><Dashicon name="yes"/> Title and description <a href="#"
                                                                                onClick={ this.handleSkipTo.bind(this, Paths.SITE_TITLE_STEP_SLUG ) }>(edit)</a>
                            </li>
                            <li><Dashicon name="yes"/> Homepage layout <a href="#"
                                                                          onClick={ this.handleSkipTo.bind(this, Paths.IS_BLOG_STEP_SLUG ) }>(edit)</a>
                                { this.state.layout !== 'blog' ?
                                    <ul>
                                        <li><a href={ this.state.welcomeUrl }>Edit your Welcome page</a></li>
                                        { ( this.state.layout !== 'website' ) ?
                                            <li><a href={ this.state.newsUrl }>Edit your News and Updates page</a>
                                            </li> : null
                                        }
                                    </ul> :
                                    null
                            ...
                            <li><Dashicon name="yes"/>
                                { this.state.isJPConnected ?
                                    ...
                                    <a href="#"
                                       onClick={ this.handleSkipTo.bind(this, Paths.JETPACK_MODULES_STEP_SLUG ) }>Connect
                                        Jetpack: </a>
                                }
