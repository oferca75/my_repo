...
abstract class WPCOM_JSON_API_Endpoint
{
    ...
    function document($show_description = true)
    {
        ...
        <p><strong>This endpoint is deprecated in favor of version <?php echo floatval($this->new_version); ?></strong>
        </p>
    <?php } ?>
        ...
        <section class="resource-info">
            ...
            <table class="api-doc api-doc-resource-parameters api-doc-resource">
                ...
                <tr class="api-index-item">
                    ...
                    ?>
                    <td class="type api-index-item-title">
                        https://public-api.wordpress.com/rest/v<?php echo floatval($version); ?><?php echo wp_kses_post($doc['path_labeled']); ?></td>
                </tr>
        ...
        foreach (array(
            ...
            <section class="<?php echo $param_label; ?>">
                ...
                <table
                    class="api-doc api-doc-<?php echo $param_label; ?>-parameters api-doc-<?php echo strtolower(str_replace(' ', '-', $doc['group'])); ?>">
                    ...
                    <?php foreach ($doc_section as $key => $item) : ?>
                        ...
                        <tr class="api-index-item">
                            <th scope="row"
                                class="parameter api-index-item-title"><?php echo wp_kses_post($key); ?></th>
