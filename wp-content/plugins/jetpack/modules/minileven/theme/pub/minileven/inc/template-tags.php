...
function minileven_content_nav($nav_id)
{
    ...
    if ($wp_query->max_num_pages > 1) : ?>
        <nav id="<?php echo $nav_id; ?>">
            ...
            <div
                class="nav-previous"><?php next_posts_link(__('<span class="meta-nav">&laquo;</span> Older', 'jetpack')); ?></div>
            <div
                class="nav-next"><?php previous_posts_link(__('Newer <span class="meta-nav">&raquo;</span>', 'jetpack')); ?></div>
        </nav><!-- #nav-above -->
    <?php endif;
}
