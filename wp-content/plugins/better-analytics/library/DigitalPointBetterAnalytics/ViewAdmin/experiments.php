    ...
    if ($_SERVER['REQUEST_METHOD'] != 'POST') {
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="name" class="regular-text" id="ba_name"
                           value="<?php echo esc_attr(@$experiment['name']); ?>"
                           required="required"<?php echo $readOnly; ?> />
                </td>
            </tr>

            <tr valign="top">
                <th scope="row"><?php esc_html_e('Description', 'better-analytics'); ?><span
                        class="optional"><?php esc_html_e('Optional', 'better-analytics'); ?></span></th>
                <td>
                    <textarea name="description" rows="4" cols="50" id="ba_description"
                              class="large-text"<?php echo $readOnly; ?>><?php echo esc_textarea(@$experiment['extraData']['description']); ?></textarea>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="number" name="minimum_days_to_run" id="ba_minimum_days_to_run" min="3" max="90"
                           step="1"
                           value="<?php echo absint(@$experiment['minimumExperimentLengthInDays']); ?>"<?php echo $readOnly; ?> />
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="number" name="traffic_coverage" id="ba_traffic_coverage" min="1" max="100" step="1"
                           value="<?php echo $trafficCoverage; ?>"<?php echo $readOnly; ?> /> <?php esc_html_e('%', 'better-analytics'); ?>
                </td>
            </tr>

            <tr valign="top">
                <th scope="row"><?php esc_html_e('Traffic Distribution Type', 'better-analytics'); ?> <span
                ...
                <td>
                    <fieldset id="ba_equal_weighting">
                        <label>
                            <input name="equal_weighting" type="radio"
                                   value="0" <?php checked(0, empty($experiment['equalWeighting']) ? 0 : 1); ?><?php echo $readOnly; ?>>
                            <?php esc_html_e('Automatically adjust traffic dynamically ', 'better-analytics'); ?>
                        </label>
                        <br/>

                        <label>
                            <input name="equal_weighting" type="radio"
                                   value="1" <?php checked(1, empty($experiment['equalWeighting']) ? 0 : 1); ?><?php echo $readOnly; ?>>
                            <?php esc_html_e('Distribute traffic evenly across all variations', 'better-analytics'); ?>
                        </label>
            ...
            <tr valign="top">
                <th scope="row"><?php esc_html_e('Confidence Threshold', 'better-analytics'); ?> <span
                        class="dashicons-before dashicons-info tooltip" title="<?php
                    ...
                    ?>"></span></th>
                <td>
                    <input type="number" name="winner_confidence_level" id="ba_winner_confidence_level" min="25"
                           max="99.5" step="0.1"
                           value="<?php echo $winnerConfidenceLevel; ?>"<?php echo $readOnly; ?> /> <?php esc_html_e('%', 'better-analytics'); ?>
                </td>
            </tr>
	...
	color: green;
                ...
                <tr valign="top" class="dynamic_options THEME">
                    ...
                    <td>
                        ...
                        <a id="new_theme_variation"
                           class="button variation_button"><?php esc_html_e('Add another theme variation', 'better-analytics') ?></a>
