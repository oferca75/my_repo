        ...
        <dl>
            ...
            <dd>
                <select id="<?php echo $this->get_field_id('orderby') ?>"
                    ...
                    <option
                        value="name" <?php if ($instance['orderby'] == 'name') echo 'selected="selected"' ?> ><?php _e('Name', 'jcl_i18n') ?></option>
                    <option
                        value="id" <?php if ($instance['orderby'] == 'id') echo 'selected="selected"' ?> ><?php _e('Category ID', 'jcl_i18n') ?></option>
                    <option
                        value="count" <?php if ($instance['orderby'] == 'count') echo 'selected="selected"' ?> ><?php _e('Entries count', 'jcl_i18n') ?></option>
                    <option
                        value="slug" <?php if ($instance['orderby'] == 'slug') echo 'selected="selected"' ?> ><?php _e('Slug', 'jcl_i18n') ?></option>
                </select>
                <select id="<?php echo $this->get_field_id('orderdir') ?>"
                        name="<?php echo $this->get_field_name('orderdir') ?>">
                    <option
                        value="ASC" <?php if ($instance['orderdir'] == 'ASC') echo 'selected="selected"' ?> ><?php _e('ASC', 'jcl_i18n') ?></option>
                    <option
                        value="DESC" <?php if ($instance['orderdir'] == 'DESC') echo 'selected="selected"' ?> ><?php _e('DESC', 'jcl_i18n') ?></option>
                </select>
            </dd>
            ...
            <dd>
                <input id="<?php echo $this->get_field_id('showcount') ?>" value="1"
                       ...
                       type="checkbox" <?php if ($instance['showcount']) echo 'checked="checked"' ?> />
            ...
            <dd>
                <input id="<?php echo $this->get_field_id('show_empty') ?>" value="1"
                       ...
                       type="checkbox" <?php if (!empty($instance['show_empty'])) echo 'checked="checked"' ?> />
            ...
            <dd>
                <input id="<?php echo $this->get_field_id('parent_expand') ?>" value="1"
                       ...
                       type="checkbox" <?php if (!empty($instance['parent_expand'])) echo 'checked="checked"' ?> />
