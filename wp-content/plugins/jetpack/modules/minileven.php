...
function minileven_configuration_screen()
{
	...
	<form method="post">
		...
		<table id="menu" class="form-table">
			<tr valign="top">
				...
				<td>
					<label>
						<input name="wp_mobile_excerpt" type="radio" value="1"
							   class="code" <?php checked(1, $excerpts, true); ?> />
						<?php _e('Enable excerpts on front page and on archive pages', 'jetpack'); ?>
					</label>
					<br/>
					<label>
						<input name="wp_mobile_excerpt" type="radio" value="0"
							   class="code" <?php checked(0, $excerpts, true); ?> />
			...
			<tr valign="top">
				...
				<td>
					<label>
						<input name="wp_mobile_featured_images" type="radio" value="0"
							   class="code" <?php checked(0, $featured_images, true); ?> />
						<?php _e('Hide all featured images', 'jetpack'); ?>
					</label>
					<br/>
					<label>
						<input name="wp_mobile_featured_images" type="radio" value="1"
							   class="code" <?php checked(1, $featured_images, true); ?> />
			...
			<tr valign="top">
				...
				<td>
					<label>
						<input name="wp_mobile_app_promos" type="checkbox"
							   value="1" <?php checked(1, $promos, true); ?> />
	...
	<a href="https://wordpress.org/mobile/" target="_blank"><img
			src="<?php echo plugin_dir_url(__FILE__); ?>/minileven/images/wp-app-devices.png" width="332" height="73"/></a>
