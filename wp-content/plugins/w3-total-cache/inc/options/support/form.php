...
<form id="support_form" class="w3tc-ignore-change" action="admin.php?page=<?php echo $this->_page; ?>" method="post"
    ...
    <div class="metabox-holder">
        ...
        <p>
            ...
            <input type="submit" name="w3tc_support_request" class="button-primary"
                   value="<?php _e('Submit request', 'w3-total-cache'); ?>"/>
            <input id="support_cancel" class="button-secondary {nonce: '<?php echo wp_create_nonce('w3tc'); ?>'}"
                   type="button" value="<?php _e('Cancel', 'w3-total-cache'); ?>"/>
        </p>
    </div>
</form>
