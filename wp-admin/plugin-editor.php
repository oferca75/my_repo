...
if (empty($plugins)) {
    ...
    <div class="wrap">
        ...
        <div id="message" class="error">
            <p><?php _e('You do not appear to have any plugins available at this time.'); ?></p></div>
    </div>
    <?php
    ...
    <?php endif; ?>
        <div class="wrap">
            ...
            <form name="template" id="template" action="plugin-editor.php" method="post">
                ...
                <div><textarea cols="70" rows="25" name="newcontent" id="newcontent"
                ...
                <?php if (!empty($docs_select)) : ?>
                    <div id="documentation" class="hide-if-no-js"><label
                            for="docs-list"><?php _e('Documentation:') ?></label> <?php echo $docs_select ?> <input
                            type="button" class="button" value="<?php esc_attr_e('Look Up') ?> "
