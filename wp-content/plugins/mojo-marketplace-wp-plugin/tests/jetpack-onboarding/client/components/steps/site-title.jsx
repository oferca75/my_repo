            ...
            <WelcomeSection id="welcome__site-title">
                ...
                <form onSubmit={ this.handleSubmit } className="welcome__site-title--form">
                    ...
                    <input type="text" name="site_title" id="site-title" autoComplete="off"
                           ...
                           placeholder="e.g. My WordPress site" required/>
                    <label htmlFor="site_description">Site Description</label>
                    <input type="text" name="site_description" id="site-description" autoComplete="off"
                           onChange={ this.handleChangeDescription } value={ this.state.description }
                           placeholder="e.g. Just another WordPress blog" required/>
