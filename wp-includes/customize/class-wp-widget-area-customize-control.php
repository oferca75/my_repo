...
class WP_Widget_Area_Customize_Control extends WP_Customize_Control
{
    ...
    public function render_content()
    {
        ...
        ?>
        <button type="button" class="button-secondary add-new-widget" aria-expanded="false"
                aria-controls="available-widgets">
            <?php _e('Add a Widget'); ?>
        </button>
        ...
        <p class="screen-reader-text"
           id="<?php echo esc_attr($id); ?>"><?php _e('When in reorder mode, additional controls to reorder widgets will be available in the widgets list above.'); ?></p>
        <?php
    }
}
