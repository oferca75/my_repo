...
function mm_cs_notice_display()
{
    if ('true' === get_option('mm_coming_soon', 'false')) {
        ...
        <div class='notice notice-info'>
            <p>Your site is currently displaying a "Coming Soon" page. Once you are ready to launch your site <a
                    href='<?php echo esc_url(add_query_arg(array('mm_cs_launch' => true))); ?>'>click here</a>.</p>
        </div>
        <?php
    }
}
...
function mm_cs_notice_launch_message()
{
    ...
    <div class='notice updated'>
        <p>Congratulations. Your site is now live, <a target='_blank'
                                                      href='<?php echo esc_url(get_option('siteurl')); ?>'>click
                here</a> to view it.</p>
    </div>
    <?php
}
