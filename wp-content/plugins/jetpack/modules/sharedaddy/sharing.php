            ...
            <?php if (0 === strpos($service->get_id(), 'custom-') || $service->has_advanced_options()) : ?>
                ...
                <form method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
                    ...
                    <input type="hidden" name="_wpnonce"
                           value="<?php echo wp_create_nonce('sharing-options_' . $id); ?>"/>
                </form>
            <?php endif; ?>
        </li>
        <?php
                    ...
                    <div id="services-config">
                        <table id="available-services">
                            <tr>
                                <td class="description">
                                    ...
                                    <p><a href="#TB_inline?height=395&amp;width=600&amp;inlineId=new-service"
                                          class="thickbox"
                                          id="add-a-new-service"><?php _e('Add a new service', 'jetpack'); ?></a></p>
                                </td>
                                <td class="services">
                                ...
                                <td class="description">
                                    <h3>
                                        ...
                                        <img src="<?php echo admin_url('images/loading.gif'); ?>" width="16" height="16"
                                             alt="loading" style="vertical-align: middle; display: none"/>
                                    </h3>
                                        ...
                                        <div class="sd-content">
                                            <ul class="preview">
                                                ...
                                                <?php if (count($enabled['hidden']) > 0) : ?>
                                                    <li class="advanced"><a href="#"
                                                                            class="sharing-anchor sd-button share-more"><span><?php _e('More', 'jetpack'); ?></span></a>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                            ...
                                            <?php if (count($enabled['hidden']) > 0) : ?>
                                                <div class="sharing-hidden">
                                                    <div class="inner"
                                                         style="display: none; <?php echo count($enabled['hidden']) == 1 ? 'width:150px;' : ''; ?>">
                        ...
                        <form method="post" action="<?php echo admin_url('admin-ajax.php'); ?>"
                            ...
                            <input type="hidden" name="visible"
                                   value="<?php echo implode(',', array_keys($enabled['visible'])); ?>"/>
                            <input type="hidden" name="hidden"
                                   value="<?php echo implode(',', array_keys($enabled['hidden'])); ?>"/>
                            <input type="hidden" name="_wpnonce"
                                   value="<?php echo wp_create_nonce('sharing-options'); ?>"/>
                        </form>
                    </div>
                    ...
                    <form method="post" action="">
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <select name="button_style" id="button_style">
                                        <option<?php if ($global['button_style'] == 'icon-text') echo ' selected="selected"'; ?>
                                            value="icon-text"><?php _e('Icon + text', 'jetpack'); ?></option>
                                        <option<?php if ($global['button_style'] == 'icon') echo ' selected="selected"'; ?>
                                            value="icon"><?php _e('Icon only', 'jetpack'); ?></option>
                                        <option<?php if ($global['button_style'] == 'text') echo ' selected="selected"'; ?>
                                            value="text"><?php _e('Text only', 'jetpack'); ?></option>
                                        <option<?php if ($global['button_style'] == 'official') echo ' selected="selected"'; ?>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <input type="text" name="sharing_label"
                                           value="<?php echo esc_attr($global['sharing_label']); ?>"/>
                                </td>
                            </tr>
                            <?php
                            /**
                            ...
                            <td>
                                ...
                                foreach ($shows as $show) :
                                    ...
                                    ?>
                                    <?php if ($br) echo '<br />'; ?><label><input
                                    type="checkbox"<?php checked(in_array($show, $global['show'])); ?> name="show[]"
                                    value="<?php echo esc_attr($show); ?>"/> <?php echo esc_html($label); ?></label>
                        ...
                        <p class="submit">
                            <input type="submit" name="submit" class="button-primary"
                                   value="<?php _e('Save Changes', 'jetpack'); ?>"/>
                        </p>
                    ...
                    <div id="new-service" style="display: none">
                        <form method="post" action="<?php echo admin_url('admin-ajax.php'); ?>" id="new-service-form">
                            <table class="form-table">
                                <tbody>
                                <tr valign="top">
                                    <th scope="row" width="100"><label><?php _e('Service name', 'jetpack'); ?></label>
                                    </th>
                                    <td>
                                ...
                                <tr valign="top">
                                    <th scope="row" width="100"><label><?php _e('Sharing URL', 'jetpack'); ?></label>
                                    </th>
                                    <td>
                                        <input type="text" name="sharing_url" id="new_sharing_url" size="40"/>

                                        <p><?php _e('You can add the following variables to your service sharing URL:', 'jetpack'); ?>
                                            <br/>
                                            <code>%post_title%</code>, <code>%post_url%</code>,
                                            <code>%post_full_url%</code>, <code>%post_excerpt%</code>,
                                            <code>%post_tags%</code></p>
                                    </td>
                                </tr>
                                <tr valign="top">
                                ...
                                <tr valign="top" width="100">
                                    ...
                                    <td>
                                        <input type="submit" class="button-primary"
                                               value="<?php _e('Create Share Button', 'jetpack'); ?>"/>
                                        <img src="<?php echo admin_url('images/loading.gif'); ?>" width="16" height="16"
                                             alt="loading" style="vertical-align: middle; display: none"/>
                                    </td>
                                </tr>
                            ...
                            <input type="hidden" name="_wpnonce"
                                   value="<?php echo wp_create_nonce('sharing-new_service'); ?>"/>
                        </form>
                    </div>
                </div>
