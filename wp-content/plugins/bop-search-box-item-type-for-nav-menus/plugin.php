...
if (!class_exists('Bop_Nav_Search_Box_Item') && !function_exists('bop_nav_search_box_item')):
    ...
    class Bop_Nav_Search_Box_Item
    {
            ...
            <div class="customlinkdiv" id="searchboxitemdiv">
                <div class="tabs-panel-active">
                    <ul class="categorychecklist">
                        <li>
                            <input type="hidden" name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-type]"
                                   value="search">
                            <input type="hidden"
                                   name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-type_label]"
                                   value="<?php echo _x('Search Box', 'type-label', 'bop-nav-search-box-item') ?>">

                            <input type="hidden" class="menu-item-title"
                                   name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-title]"
                                   value="<?php echo _x('Search', 'default-title', 'bop-nav-search-box-item') ?>">
                            <input type="hidden" class="menu-item-url"
                                   name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-url]"
                                   value="<?php echo esc_attr(get_search_link()); ?>">
                            <input type="hidden" class="menu-item-classes"
                                   name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-classes]"
                                   value="bop-nav-search">

                            <input type="checkbox" class="menu-item-object-id"
                                   name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-object-id]"
                                   value="<?php echo $_nav_menu_placeholder; ?>" checked="true">
                        </li>
                    </ul>
                </div>
				...
				<span class="add-to-menu">
					<input type="submit"<?php wp_nav_menu_disabled_check($nav_menu_selected_id); ?>
                           ...
                           value="<?php echo esc_attr_x('Add to menu', 'meta-box-submit', 'bop-nav-search-box-item'); ?>"
        ...
        function walker_nav_menu_start_el($item_output, $item, $depth, $args)
        {
            ...
            if ('html5' == $format):
                ?>
                <form <?php echo $id . $class_names ?> role="search" method="get"
                    ...
                    <label>
                        ...
                        ?>
                        <input type="search" class="search-field" placeholder="<?php echo $attr_title ?>"
                               value="<?php echo get_search_query() ?>" name="s" title="<?php echo $attr_title ?>"/>
                    </label>
                    <?php
                    ...
                    if (apply_filters('bop_nav_search_show_submit_button', true, $item, $depth, $args)): ?>
                        <input type="image" src="<?php echo get_stylesheet_directory_uri() ?>/img/magnifying-glass.png"
                               class="search-submit" value="<?php

                        /** https://www.google.co.il/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=0ahUKEwisuf_N65DMAhUJPhQKHdQrAkUQjRwIBw&url=%2Furl%3Fsa%3Di%26rct%3Dj%26q%3D%26esrc%3Ds%26source%3Dimages%26cd%3D%26cad%3Drja%26uact%3D8%26ved%3D0ahUKEwisuf_N65DMAhUJPhQKHdQrAkUQjRwIBw%26url%3Dhttp%253A%252F%252Fdownloadicons.net%252Fmagnifying-glass-icons%253Fpage%253D17%26bvm%3Dbv.119408272%2Cd.bGg%26psig%3DAFQjCNE1DiXQeIbl2N7AWQCbsKK36r86Qw%26ust%3D1460816470444508&bvm=bv.119408272,d.bGg&psig=AFQjCNE1DiXQeIbl2N7AWQCbsKK36r86Qw&ust=1460816470444508
