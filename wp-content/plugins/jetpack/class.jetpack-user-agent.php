...
class Jetpack_User_Agent_Info
{
    ...
    const PLATFORM_IPOD = 'ipod'; //Stores whether is the iPhone tier of devices.
    const PLATFORM_IPAD = 'ipad'; //Stores whether the device can probably support Rich CSS, but JavaScript (jQuery) support is not assumed.
    const PLATFORM_BLACKBERRY = 'blackberry'; //Stores whether it is another mobile device, which cannot be assumed to support CSS or JS (eg, older BlackBerry, RAZR)
    const PLATFORM_BLACKBERRY_10 = 'blackberry_10'; //Stores the device platform name
