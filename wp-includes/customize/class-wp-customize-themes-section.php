        ...
        <li id="accordion-section-<?php echo esc_attr($this->id); ?>" class="<?php echo esc_attr($classes); ?>">
            <h3 class="accordion-section-title">
                ...
                <?php if (count($this->controls) > 0) : ?>
                    <button type="button" class="button change-theme"
                            tabindex="0"><?php _ex('Change', 'theme'); ?></button>
                <?php endif; ?>
            </h3>
            <div class="customize-themes-panel control-panel-content themes-php">
                <h3 class="accordion-section-title customize-section-title">
                    ...
                    <?php _e('Themes'); ?>
                    <span class="title-count theme-count"><?php echo count($this->controls) + 1 /* Active theme */
                        ; ?></span>
                </h3>
                <h3 class="accordion-section-title customize-section-title">
                    <?php
                ...
                <div class="theme-overlay" tabindex="0" role="dialog"
                ...
                <?php if (count($this->controls) > 4) : ?>
                    <p><label for="themes-filter">
                            ...
                            <input type="text" id="themes-filter"
                                   placeholder="<?php esc_attr_e('Search installed themes&hellip;'); ?>"/>
                        </label></p>
                <?php endif; ?>
