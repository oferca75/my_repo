...
<?php include W3TC_INC_DIR . '/options/common/header.php'; ?>
    ...
    <div id="install">
        ...
        <p id="memcached">
            <strong><?php _e('Memcached (Daemon) Installation:</strong><br /><em>Time required: 2 minutes</em>', 'w3-total-cache'); ?>
        </p>
        ...
        <ol>
            <li>
                ...
                <pre class="console"># cd /usr/local/src &amp;&amp; wget <a
                        href="http://www.monkey.org/~provos/libevent-2.0.12-stable.tar.gz" target="_blank">http://monkey.org/~provos/libevent-2.0.14-stable.tar.gz</a> &amp;&amp; tar -xzf libevent-2.0.12-stable.tar.gz &amp;&amp; cd libevent-2.0.12-stable</pre>
            </li>
            <li>
            ...
            <li>
                ...
                <pre
                    class="console"><?php echo sprintf(__('Libraries have been installed in: %s', 'w3-total-cache'), '/usr/local/lib'); ?></pre>
            ...
            <li>
                ...
                <pre class="console"># cd /usr/local/src &amp;&amp; wget <a
                        href="http://memcached.googlecode.com/files/memcached-1.4.6.tar.gz" target="_blank">http://memcached.googlecode.com/files/memcached-1.4.6.tar.gz</a> &amp;&amp; tar -xzf memcached-1.4.6.tar.gz &amp;&amp; cd memcached-1.4.6</pre>
            </li>
            <li>
                <?php _e('Let\'s compile:', 'w3-total-cache'); ?>
                <pre class="console"># ./configure &amp;&amp; make &amp;&amp; make install</pre>
...
# echo '/etc/init.d/memcached' &gt;&gt; /etc/rc.local</pre>
        ...
        <ol>
            ...
            <li>
                ...
                <pre class="console"># cd /usr/local/src/ &amp;&amp; wget <a
                        href="http://pecl.php.net/get/memcache-2.2.6.tgz" target="_blank">http://pecl.php.net/get/memcache-2.2.6.tgz</a> &amp;&amp; tar -xzf memcache-2.2.6.tgz &amp;&amp; cd memcache-2.2.6</pre>
            </li>
            <li>
        ...
        <ol>
            ...
            <li>
                ...
                <pre class="console"># cd /usr/local/src &amp;&amp; wget <a href="http://pecl.php.net/get/APC-3.1.9.tgz"
                                                                            target="_blank">http://pecl.php.net/get/APC-3.1.9.tgz</a> &amp;&amp; tar -xzf APC-3.1.9.tgz &amp;&amp; cd APC-3.1.9</pre>
            </li>
            <li>
...
# whereis apxs</pre>
            ...
            <li>
                ...
                <pre
                    class="console"><?php echo sprintf(__('Installing shared extensions: %s', 'w3-total-cache'), '/usr/lib/php/modules/'); ?></pre>
            </li>
            <li>
        ...
        <ol>
            <li>
                ...
                <pre class="console"># cd /usr/local/src &amp;&amp; wget <a
                        href="http://xcache.lighttpd.net/pub/Releases/1.3.2/xcache-1.3.2.tar.gz" target="_blank">http://xcache.lighttpd.net/pub/Releases/1.3.2/xcache-1.3.2.tar.gz</a> &amp;&amp; tar -xzf xcache-1.3.2.tar.gz &amp;&amp; cd xcache-1.3.2</pre>
            </li>
            <li>
        ...
        <ol>
            <li>
                ...
                <pre class="console"># cd /usr/local/src &amp;&amp; wget <a
                        href="http://autosetup1.googlecode.com/files/eaccelerator-0.9.5.3.tar.bz2" target="_blank">http://autosetup1.googlecode.com/files/eaccelerator-0.9.5.3.tar.bz2</a> &amp;&amp; tar -xjf eaccelerator-0.9.5.3.tar.bz2 &amp;&amp; cd eaccelerator-0.9.5.3</pre>
            </li>
            <li>
                <?php _e('Note the path returned for the following command:', 'w3-total-cache'); ?>
                <pre class="console"># whereis php-config</pre>
        ...
        <p>
            Find requirements and installation instructions on New Relic website: <a
                href="https://newrelic.com/docs/php/new-relic-for-php" target="_blank">Installing New Relic for PHP</a>.
            To see if this server supports New Relic click "compatibility check" on the <a
                href="<?php echo admin_url('admin.php?page=w3tc_dashboard') ?>">Dashboard tab</a>. Other key resources
            can be found below:
        </p>
        <ul>
            <li><a href="https://newrelic.com/docs/php/quick-installation-instructions-advanced-users" target="_blank">Quick
                    Installation Instructions (Advanced Users)</a></li>
            <li><a href="https://newrelic.com/docs/php/the-newrelic-install-script" target="_blank">The newrelic-install
                    Script</a></li>
            <li><a href="https://newrelic.com/docs/php/php-agent-installation-redhat-and-centos" target="_blank">Installing
                    with yum or rpm (RedHat, CentOS)</a></li>
            <li><a href="https://newrelic.com/docs/php/php-agent-installation-ubuntu-and-debian" target="_blank">Installing
                    with dpkg or apt (Ubuntu, Debian)</a></li>
            <li><a href="https://newrelic.com/docs/php/php-agent-installation-tar-files" target="_blank">Installing from
                    tar Files (other Linux variants, OpenSolaris, FreeBSD)</a></li>
            <li><a href="https://newrelic.com/docs/php/newrelic-daemon-startup-modes" target="_blank">New Relic Daemon
                    Startup Modes</a></li>
        </ul>
        <hr/>
