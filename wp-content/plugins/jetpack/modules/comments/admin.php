...
class Jetpack_Comments_Settings
{
    ...
    public function comment_form_greeting_setting()
    {
        ...
        <input type="text" name="highlander_comment_form_prompt" id="jetpack-comment-form-greeting"
               value="<?php echo esc_attr($greeting); ?>" class="regular-text">
    ...
    public function comment_form_color_scheme_setting()
    {
        ...
        <fieldset>
            ...
            <?php foreach ($this->color_schemes as $key => $label) : ?>
                ...
                <label>
                    <input type="radio" name="jetpack_comment_form_color_scheme" id="jetpack-comment-form-color-scheme"
                           value="<?php echo $key; ?>" <?php checked($scheme, $key); ?>>
                    <?php echo $label; ?>
                </label>
                <br/>
