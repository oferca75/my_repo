...
<div id="getting_started" class="zerif-lite-tab-pane active">
    ...
    <div class="zerif-tab-pane-center">
        ...
        <h1 class="zerif-lite-welcome-title">Welcome to Zerif Lite! <?php if (!empty($zerif_lite['Version'])): ?> <sup
                id="zerif-lite-theme-version"><?php echo esc_attr($zerif_lite['Version']); ?> </sup><?php endif; ?></h1>
    ...
    <div class="zerif-tab-pane-center">
        ...
        <p><a href="<?php echo esc_url($customizer_url); ?>"
              class="button button-primary"><?php esc_html_e('Go to Customizer', 'zerif-lite'); ?></a></p>
    ...
    <div class="zerif-tab-pane-half zerif-tab-pane-first-half">
        ...
        <p><a href="<?php echo esc_url('http://docs.themeisle.com/article/14-how-to-create-a-child-theme/'); ?>"
              class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/219-how-to-build-a-landing-page-with-a-drag-and-drop-content-builder'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p><a href="<?php echo esc_url('http://docs.themeisle.com/article/80-how-to-translate-zerif'); ?>"
              class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/249-how-to-increase-the-size-of-social-icons-in-zerif'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/15-turn-off-loading-animations-in-zerif/'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/78-zerif-adding-a-search-bar-in-the-top-menu'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/13-replacing-big-title-section-with-an-image-slider/'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
    ...
    <div class="zerif-tab-pane-half">
        ...
        <p><a href="<?php echo esc_url('http://docs.themeisle.com/article/63-speed-up-your-wordpress-site/'); ?>"
              class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/33-how-to-link-menus-to-sections-in-zerif/'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/36-how-to-change-section-anchor-in-zerif/'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/32-how-to-change-the-page-template-in-wordpress'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p>
            <a href="<?php echo esc_url('http://docs.themeisle.com/article/30-removing-background-opacity-in-zerif/'); ?>"
               class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p><a href="<?php echo esc_url('http://docs.themeisle.com/article/85-configuring-portfolio/'); ?>"
              class="button"><?php esc_html_e('View how to do this', 'zerif-lite'); ?></a></p>
        ...
        <p><a href="<?php echo esc_url('http://www.codeinwp.com/blog/top-non-obvious-wordpress-plugins/'); ?>"
              class="button"><?php esc_html_e('Read more', 'zerif-lite'); ?></a></p>
    ...
    <div class="zerif-tab-pane-center">
        ...
        <p><a href="<?php echo esc_url('http://themeisle.com/documentation-zerif-lite/'); ?>"
              class="button button-primary"><?php esc_html_e('Read full documentation', 'zerif-lite'); ?></a></p>
    ...
    <div class="zerif-tab-pane-half zerif-tab-pane-first-half">
        ...
        <?php if (is_plugin_active('siteorigin-panels/siteorigin-panels.php')) { ?>
            ...
            <p><span
                    class="zerif-lite-w-activated button"><?php esc_html_e('Already activated', 'zerif-lite'); ?></span>
            </p>
            ...
            <p>
                <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=siteorigin-panels'), 'install-plugin_siteorigin-panels')); ?>"
                   class="button button-primary"><?php esc_html_e('Install Page Builder by SiteOrigin', 'zerif-lite'); ?></a>
            </p>
        ...
        <?php if (is_plugin_active('wp-product-review/wp-product-review.php')) { ?>
            ...
            <p>
                <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=wp-product-review'), 'install-plugin_wp-product-review')); ?>"
                   class="button button-primary"><?php esc_html_e('Install WP Product Review', 'zerif-lite'); ?></a></p>
        ...
        <?php if (is_plugin_active('login-customizer/login-customizer.php')) { ?>
            ...
            <p>
                <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=login-customizer'), 'install-plugin_login-customizer')); ?>"
                   class="button button-primary"><?php esc_html_e('Install Custom Login Customizer', 'zerif-lite'); ?></a>
            </p>
    ...
    <div class="zerif-tab-pane-half">
        ...
        <?php if (class_exists('Visualizer_Plugin')) { ?>
            ...
            <p>
                <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=visualizer'), 'install-plugin_visualizer')); ?>"
                   class="button button-primary"><?php esc_html_e('Install Visualizer', 'zerif-lite'); ?></a></p>
        ...
        <?php if (is_plugin_active('easy-content-types/easy-content-types.php')) { ?>
            ...
            <p><a href="<?php echo esc_url('http://themeisle.com/plugins/easy-content-types/'); ?>"
                  class="button button-primary"><?php esc_html_e('Download Easy Content Types', 'zerif-lite'); ?></a>
            </p>
        ...
        <?php if (is_plugin_active('tweet-old-post/tweet-old-post.php')) { ?>
            ...
            <p>
                <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=tweet-old-post'), 'install-plugin_tweet-old-post')); ?>"
                   class="button button-primary"><?php esc_html_e('Install Revive Old Post', 'zerif-lite'); ?></a></p>
