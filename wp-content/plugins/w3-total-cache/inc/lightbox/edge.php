...
<div id="w3tc-edge-mode">
    ...
    <div class="content">
        <p>
            <strong><?php _e('You can now keep up-to-date on all of the web performance optimization (WPO) techniques that will make your website as fast as possible without having to worry about new features breaking your website when you update!', 'w3-total-cache') ?></strong>
        </p>
    ...
    <div class="footer">
        ...
        <input type="button" class="button-cancel btn w3tc-size btn-default outset palette-light-grey"
               value="<?php _e('Cancel', 'w3-total-cache') ?>">
    </div>
</div>
