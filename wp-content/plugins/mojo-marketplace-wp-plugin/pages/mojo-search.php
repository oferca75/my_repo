                            ...
                            <div class="col-xs-12 col-sm-4">
								...
								<span class="fake-select">
									<select class="form-control input-sm" id="sort_select">
                                        <option value='all'<?php selected('all', $query['item_type']); ?>>Select
                                        </option>
                                        <option value='themes'<?php selected('themes', $query['item_type']); ?>>Themes
                                        </option>
                                        <option value='plugins'<?php selected('plugins', $query['item_type']); ?>>
                                            Plugins
                                        </option>
                                        <option value='services'<?php selected('services', $query['item_type']); ?>>
                                            Services
                                        </option>
                                        <option value='graphics'<?php selected('graphics', $query['item_type']); ?>>
                                            Graphics
                                        </option>
                                    </select>
								</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-5 col-md-5">
                                            <div class="description-box">
                                                <h2>
                                                    <a href="<?php echo esc_url(add_query_arg(array('page' => 'mojo-single-item', 'item_id' => $item->id), admin_url('admin.php'))); ?>"><?php echo apply_filters('mm_item_name', $item->name); ?></a>
                                                </h2>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-2">
                                            <div class="text-center info-box">
                                                ...
                                                <div class="btn-group-vertical" role="group">
                                                    ...
                                                    <a href="<?php echo mm_build_link(add_query_arg(array('item_id' => $item->id), 'https://www.mojomarketplace.com/cart'), array('utm_medium' => 'plugin_admin', 'utm_content' => 'buy_now_search')); ?>"
                                                       class="btn btn-success btn-lg"
                                                       data-price="<?php echo number_format($item->prices->single_domain_license); ?>"
                                                       data-view="search_list">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
