...
<div id="netdna-widget" class="maxcdn-netdna-widget-base">
    <div class="wrapper">
        ...
        <div class="tools area">
            <ul>
                <li><a class="button"
                       href="<?php echo "https://cp.netdna.com/zones/pull/{$zone_id}" ?>"><?php _e('Manage', 'w3-total-cache') ?></a>
                </li>
                <li><a class="button"
                       href="<?php echo "https://cp.netdna.com/reporting/{$zone_id}" ?>"><?php _e('Reports', 'w3-total-cache') ?></a>
                </li>
                <li><a class="button"
