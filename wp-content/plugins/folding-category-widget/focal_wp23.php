...
Class FoldingCategoryList
{
    ...
    function RegisterWidgets()
    {
        ...
        for ($i = 1; $i <= 9; $i++) {
            ...
            register_sidebar_widget($name, $i <= $number ? array(&$this, 'widget_FocalWidget') : /* unregister */
                '', $i);
            register_widget_control($name, $i <= $number ? array(&$this, 'widget_FocalWidgetControl') : /* unregister */
                '', 200, 200, $i);
        }
    }
        ...
        switch ($this->widgetOptions[$number]['CSSTheme']) {
            ...
            case 'indent_arrowbullet':
                ...
                .FoldingCategoryList li ul li {
                    background-image: url('<?php echo get_option('siteurl');?>/wp-content/plugins/folding-category-widget/themes/0099_sosimple.png');
            ...
            case 'indent_circlebullet':
                ...
                .FoldingCategoryList li ul li {
                    background-image: url('<?php echo get_option('siteurl');?>/wp-content/plugins/folding-category-widget/themes/bullet_green.gif');
                    background-repeat: no-repeat;
                    padding-left: 12px;
                    background-position: top left
                }
            ...
            case 'explorer':
                ...
                .selectedparent, .selectedhaschildren {
                    margin-left: -10px;
                    padding-left: 10px;
                    background-image: url('<?php echo get_option('siteurl');?>/wp-content/plugins/folding-category-widget/themes/bullet_toggle_minus.gif');
                    background-repeat: no-repeat;
                    background-position: top left
                }

                .haschildren {
                    background-image: url('<?php echo get_option('siteurl');?>/wp-content/plugins/folding-category-widget/themes/bullet_toggle_plus.gif');
                    background-repeat: no-repeat;
                    background-position: top left
                }
        ...
        <div>
            <div class="wrap">
                <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                    ...
                    <p>The Folding Category List provides a fast and efficient replacement for the category list which
                        which allows categories to be folded, or collapsed, allowing more room on your sidebar. These
                        options allow you to customise each widget indipendantly.</p>
                    ...
                    <span style="font-style:italic">You have <?php echo $this->defaultOptions['NumberOfWidgets']; ?>
                        widget(s) enabled for use on the sidebar. To add more please visit the Widgets admin page.</span>
                    <br/>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                </select> &nbsp; <input type="submit" name="focalChangeWidget"
                                                        value="<?php _e('Set', 'focal'); ?>" class="button"/><br/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="focal_widegtTitle" size="20"
                                       value="<?php echo $this->widgetOptions[$selectedWidget]['Title'] ?>"/><br/>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (function_exists('wp_category_checklist')) { ?>
                                    <div id="categorydiv"
                                         style="height:170px; width:220px; overflow:auto; background-color:white;padding:8px;">
                                ...
                                <?php } else {
                                    ...
                                    <input type="text" name="focal_widgetExcluded" size="20"
                                           value="<?php echo implode(",", $this->widgetOptions[$selectedWidget]['ExcludeCats']) ?>"/>
                                    <br/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="focal_widegtPriority" id="focal_widegtPriority" size="40"
                                       value="<?php echo $this->widgetOptions[$selectedWidget]['HightlightPriority'] ?>"/><br/>
                        ...
                        <tr>
                            ...
                            <td><?php
                                ...
                                if ($this->widgetOptions[$selectedWidget]['OrderBy'] == "name") {
                                    $name = " selected";
                                    $value = "name";
                                }
                                if ($this->widgetOptions[$selectedWidget]['OrderBy'] == "id") {
                                    $id = " selected";
                                    $value = "id";
                                }
                                if ($this->widgetOptions[$selectedWidget]['OrderBy'] == "description") {
                                    $description = " selected";
                                    $value = "description";
                                }
                                if ($this->widgetOptions[$selectedWidget]['OrderBy'] == "slug") {
                                    $slug = " selected";
                                    $value = "";
                                }
                                if ($this->widgetOptions[$selectedWidget]['OrderBy'] == "postcount") {
                                    $postcount = " selected";
                                    $value = "postcount";
                                }
                                if ($this->widgetOptions[$selectedWidget]['OrderBy'] == "mycategoryorder") {
                                    $mycategoryorder = " selected";
                                    $value = "mycategoryorder";
                                }

                                if ($this->widgetOptions[$selectedWidget]['OrderByDirection'] == "asc") {
                                    $asc = " selected";
                                    $valuea = "asc";
                                }
                                if ($this->widgetOptions[$selectedWidget]['OrderByDirection'] == "desc") {
                                    $desc = " selected";
                                    $valuea = "desc";
                                }
                                ...
                                <select name="focal_widgetSortBy" id="focal_widgetSortBy" value="<?php echo $value; ?>">
                                    ...
                                    <option<?php echo $mycategoryorder; ?> value="mycategoryorder">My Category
                                            Order</option><?php } ?>
                                ...
                                <span>How should the list be sorted? <?php if (function_exists("mycategoryorder_init")) { ?>
                                        <em>nb: if selecting My Category Order you must manually rebuild the cache after
                                            changing the order.</em><?php } ?></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" id="focal_ShowPostCount"
                                       name="focal_ShowPostCount" <?php echo ($this->widgetOptions[$selectedWidget]['ShowPostCount']) ? "checked" : ""; ?>/><label
                                    for="focal_ShowPostCount">Show post count</label><br/>
                                <input type="checkbox" id="focal_ShowPostCountUnique"
                                       name="focal_ShowPostCountUnique" <?php echo ($this->widgetOptions[$selectedWidget]['ShowPostCountUnique']) ? "checked" : ""; ?>/><label
                                    for="focal_ShowPostCountUnique">Show unique posts only</label><br/>
                                ...
                                <br/>
                                <label for="focal_widegtCountBefore">Before post count: </label><input type="text"
                                                                                                       name="focal_widegtCountBefore"
                                                                                                       id="focal_widegtCountBefore"
                                                                                                       size="20"
                                                                                                       value="<?php echo $this->widgetOptions[$selectedWidget]['CountBefore'] ?>"/><br/>
                                <label for="focal_widegtCountAfter">After post count: </label><input type="text"
                                                                                                     name="focal_widegtCountAfter"
                                                                                                     id="focal_widegtAfterBefore"
                                                                                                     size="20"
                                                                                                     value="<?php echo $this->widgetOptions[$selectedWidget]['CountAfter'] ?>"/><br/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" id="focal_UseDescriptionAsCategoryText"
                                       name="focal_UseDescriptionAsCategoryText" <?php echo ($this->widgetOptions[$selectedWidget]['UseDescriptionAsCategoryText']) ? "checked" : ""; ?>/><label
                                    for="focal_UseDescriptionAsCategoryText">Use category description as the link
                                    text.</label><br/>
                                <input type="checkbox" id="focal_UseDescriptionAsCategoryTitle"
                                       name="focal_UseDescriptionAsCategoryTitle" <?php echo ($this->widgetOptions[$selectedWidget]['UseDescriptionAsCategoryTitle']) ? "checked" : ""; ?>/><label
                                    for="focal_UseDescriptionAsCategoryTitle">Use category description as the popup
                                    (title) text.</label><br/>
                                <input type="checkbox" id="focal_DontLinkCurrentCategory"
                                       name="focal_DontLinkCurrentCategory" <?php echo ($this->widgetOptions[$selectedWidget]['DontLinkCurrentCategory']) ? "checked" : ""; ?>/><label
                                    for="focal_DontLinkCurrentCategory">Don't add link for current (selected)
                                    category</label><br/>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span>Text before and after the link are not included as the anchor tag, so you can have "Visit <span
                                        style="text-decoration:underline">my photos</span> page".</span></br>
                                </br></br>
                                <p><span>Links before the category list:</span><br/></br>
                                    <textarea name="focal_widgetLinksBefore" id="focal_widgetLinksBefore"
                                              style="width:80%; height:80px"><?php echo($this->widgetOptions[$selectedWidget]['LinksBefore']); ?></textarea>
                                </p>
                                <p><span>Links after the category list:</span><br/></br>
                                    <textarea name="focal_widgetLinksAfter" id="focal_widgetLinksAfter"
                                              style="width:80%; height:80px"><?php echo($this->widgetOptions[$selectedWidget]['LinksAfter']); ?></textarea>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" id="focal_OutputCatIDs"
                                       name="focal_OutputCatIDs" <?php echo ($this->widgetOptions[$selectedWidget]['OutputCatIDs']) ? "checked" : ""; ?>/><label
                                    for="focal_OutputCatIDs">Use category ID as CSS ID on &lt;li&gt;
                                    tags.</label><br/>
                                <?php
                                if ($this->widgetOptions[$selectedWidget]['ApplyCSSTo'] == "li") {
                                    $li = " selected";
                                    $value = "li";
                                }
                                if ($this->widgetOptions[$selectedWidget]['ApplyCSSTo'] == "a") {
                                    $a = " selected";
                                    $value = "a";
                                }
                                if ($this->widgetOptions[$selectedWidget]['ApplyCSSTo'] == "span") {
                                    $span = " selected";
                                    $value = "span";
                                }
                                ?>
                                ...
                                <?php
                                if ($this->widgetOptions[$selectedWidget]['CSSTheme'] == "none") {
                                    $none = " selected";
                                    $value = "none";
                                }
                                if ($this->widgetOptions[$selectedWidget]['CSSTheme'] == "indent") {
                                    $indent = " selected";
                                    $value = "indent";
                                }
                                if ($this->widgetOptions[$selectedWidget]['CSSTheme'] == "indent_bullet") {
                                    $indent_bullet = " selected";
                                    $value = "indent_bullet";
                                }
                                if ($this->widgetOptions[$selectedWidget]['CSSTheme'] == "indent_arrowbullet") {
                                    $indent_arrow = " selected";
                                    $value = "indent_arrowbullet";
                                }
                                if ($this->widgetOptions[$selectedWidget]['CSSTheme'] == "explorer") {
                                    $explorer = " selected";
                                    $value = "explorer";
                                }
                                ?> CSS Theme:
                                <select name="focal_widgetCSSTheme" id="focal_widgetCSSTheme"
                                        value="<?php echo $value; ?>">
                                    <option<?php echo $none; ?> value="none">None (default)</option>
                                    <option<?php echo $indent; ?> value="indent">Indented</option>
                                    <option<?php echo $indent_bullet; ?> value="indent_bullet">Indented with bullet
                                        points
                                    </option>
                                    <option<?php echo $indent_arrow; ?> value="indent_arrowbullet">Indented with
                                        arrows
                                    </option>
                                    <option<?php echo $explorer; ?> value="explorer">Explorer style + and - symbols
                                    </option>
                                </select><br/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" id="focal_ShowEmptyCats"
                                       name="focal_ShowEmptyCats" <?php echo ($this->widgetOptions[$selectedWidget]['ShowEmptyCats']) ? "checked" : ""; ?>/><label
                                    for="focal_ShowEmptyCats">Show empty categories.</label><br/>
                            </td>
                        </tr>
        ...
        <div class="wrap">
            <form method="POST">
                ...
                <p style="line-height: 30px;"><?php _e('How many Folding Category widgets would you like?', 'focal'); ?>
                    <select id="focalNumber" name="focalNumber"
                            value="<?php echo $this->defaultOptions['NumberOfWidgets']; ?>">
                        <?php for ($i = 1; $i < 10; ++$i) echo "<option value='$i' " . ($this->defaultOptions['NumberOfWidgets'] == $i ? "selected='selected'" : '') . ">$i</option>"; ?>
                    </select>
                    <span class="submit"><input type="submit" name="focalNumberSubmit" id="focalNumberSubmit"
                                                value="Save"/></span></p>
            </form>
        </div>
        <?php
