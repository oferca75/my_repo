    ...
    render: function () {
        return (
            <WelcomeSection id="welcome__homepage">
                ...
                <p className="welcome__callout welcome__homepage--callout">What should visitors see on your
                    homepage?</p>
                <form>
                    <div className="welcome__homepage-cols">
                        <div
                            ...
                            <label>
                                <input type="radio" name="site_layout" value="blog"
                                       checked={ this.state.layout === 'blog' } onChange={ this.handleSetLayout }
                        ...
                        <div
                            ...
                            <label>
                                <input type="radio" name="site_layout" value="site-blog"
                                       checked={ this.state.layout === 'site-blog' } onChange={ this.handleSetLayout }
                                       className='screen-reader-text'/>
