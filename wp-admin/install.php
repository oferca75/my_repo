...
if (false) {
    ...
    <p>WordPress requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned
        off.</p>
    </body>
    </html>
    <?php
...
<p id="logo"><a href="<?php echo esc_url(__('https://wordpress.org/')); ?>" tabindex="-1"><?php _e('WordPress'); ?></a>
</p>
    ...
    <form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
        <table class="form-table">
            <tr>
                ...
                <td><input name="weblog_title" type="text" id="weblog_title" size="25"
            ...
            <tr>
                ...
                <td>
                    ...
                    if ($user_table) {
                        ...
                        ?><input name="user_name" type="text" id="user_login" size="25"
                    ...
                    <td>
                        <div class="">
                            ...
                            <input type="password" name="admin_password" id="pass1" class="regular-text"
                                   autocomplete="off" data-reveal="1"
            ...
            <tr>
                ...
                <td><input name="admin_email" type="email" id="admin_email" size="25"
...
switch ($step) {
    ...
    case 2:
        ...
        if ($error === false) {
            ...
            <p class="step"><a href="<?php echo esc_url(wp_login_url()); ?>"
                               class="button button-large"><?php _e('Log In'); ?></a></p>
