    ...
    <div class="wrap">
        <div class="form-wrap">
            ...
            if (isset($_POST['rigwppz_form_submit']) && $_POST['rigwppz_form_submit'] == 'yes') {
                ...
                $rigwppz_title = stripslashes(sanitize_text_field($_POST['rigwppz_title']));
                $rigwppz_width = stripslashes(sanitize_text_field($_POST['rigwppz_width']));
                $rigwppz_theme = stripslashes(sanitize_text_field($_POST['rigwppz_theme']));
                $rigwppz_dir = stripslashes(sanitize_text_field($_POST['rigwppz_dir']));
                $rigwppz_title_yes = stripslashes(sanitize_text_field($_POST['rigwppz_title_yes']));
                ...
                if ($rigwppz_theme != "dark_rounded" && $rigwppz_theme != "dark_square" && $rigwppz_theme != "default" && $rigwppz_theme != "light_rounded" && $rigwppz_theme != "facebook" && $rigwppz_theme != "light_square") {
                    $rigwppz_theme = "dark_rounded";
                }

                if ($rigwppz_title_yes != "YES" && $rigwppz_title_yes != "NO") {
                    $rigwppz_title_yes = "YES";
                }
            ...
            <form name="rigwppz_form" method="post" action="">
                ...
                <input name="rigwppz_title" type="text" id="rigwppz_title" size="70" maxlength="200"
                       value="<?php echo $rigwppz_title; ?>"/>
                <p><?php _e('Please enter your widget title.', 'rigwppz'); ?></p>

                <label for="tag-title"><?php _e('Width (Only for widget)', 'rigwppz'); ?></label>
                <input name="rigwppz_width" type="text" id="rigwppz_width" maxlength="3"
                       value="<?php echo $rigwppz_width; ?>"/>
                ...
                <select name="rigwppz_theme" id="rigwppz_theme">
                    <option value='dark_rounded' <?php if ($rigwppz_theme == 'dark_rounded') {
                        echo 'selected';
                    } ?>>Dark Rounded
                    </option>
                    <option value='dark_square' <?php if ($rigwppz_theme == 'dark_square') {
                        echo 'selected';
                    } ?>>Dark Square
                    </option>
                    <option value='default' <?php if ($rigwppz_theme == 'default') {
                        echo 'selected';
                    } ?>>Default
                    </option>
                    <option value='light_rounded' <?php if ($rigwppz_theme == 'light_rounded') {
                        echo 'selected';
                    } ?>>Light Rounded
                    </option>
                    <option value='facebook' <?php if ($rigwppz_theme == 'facebook') {
                        echo 'selected';
                    } ?>>Facebook
                    </option>
                    <option value='light_square' <?php if ($rigwppz_theme == 'light_square') {
                        echo 'selected';
                    } ?>>Light Square
                    </option>
                </select>
                ...
                <select name="rigwppz_title_yes" id="rigwppz_title_yes">
                    <option value='YES' <?php if ($rigwppz_title_yes == 'YES') {
                        echo 'selected="selected"';
                    } ?>>Yes
                    </option>
                    <option value='NO' <?php if ($rigwppz_title_yes == 'NO') {
                        echo 'selected="selected"';
                    } ?>>No
                    </option>
                </select>
                ...
                <input name="rigwppz_dir1" type="text" id="rigwppz_dir1" size="110"
                       value="<?php echo $rigwppz_dir1; ?>"/>
                <p><?php _e('Please enter your image directory.', 'rigwppz'); ?> (DIR1) (Example:
                    wp-content/plugins/random-image-gallery-with-pretty-photo-zoom/random-gallery/)</p>

                <label for="tag-title"><?php _e('Image directory', 'rigwppz'); ?> (DIR2)</label>
                <input name="rigwppz_dir2" type="text" id="rigwppz_dir2" size="110"
                       value="<?php echo $rigwppz_dir2; ?>"/>
                <p><?php _e('Please enter your image directory.', 'rigwppz'); ?> (DIR2)</p>

                <label for="tag-title"><?php _e('Image directory', 'rigwppz'); ?> (DIR3)</label>
                <input name="rigwppz_dir3" type="text" id="rigwppz_dir3" size="110"
                       value="<?php echo $rigwppz_dir3; ?>"/>
                <p><?php _e('Please enter your image directory.', 'rigwppz'); ?> (DIR3)</p>

                <label for="tag-title"><?php _e('Image directory', 'rigwppz'); ?> (DIR4)</label>
                <input name="rigwppz_dir4" type="text" id="rigwppz_dir4" size="110"
                       value="<?php echo $rigwppz_dir4; ?>"/>
                <p><?php _e('Please enter your image directory.', 'rigwppz'); ?> (DIR4)</p>

                <label for="tag-title"><?php _e('Image directory', 'rigwppz'); ?> (DIR5)</label>
                <input name="rigwppz_dir5" type="text" id="rigwppz_dir5" size="110"
                       value="<?php echo $rigwppz_dir5; ?>"/>
                <p><?php _e('Please enter your image directory.', 'rigwppz'); ?> (DIR5)</p>

                <div style="height:10px;"></div>
                <input type="hidden" name="rigwppz_form_submit" value="yes"/>
                <input name="rigwppz_submit" id="rigwppz_submit" class="button add-new-h2" value="Submit"
                       type="submit"/>
        ...
        <p class="description">
            ...
            <a target="_blank"
               href="http://www.gopiplus.com/work/2011/12/12/wordpress-plugin-random-image-gallery-with-pretty-photo-zoom/"><?php _e('click here', 'rigwppz'); ?></a>
...
function rigwppz_control()
{
    ...
    ?> <a target="_blank"
          href="http://www.gopiplus.com/work/2011/12/12/wordpress-plugin-random-image-gallery-with-pretty-photo-zoom/"><?php _e('click here', 'rigwppz'); ?></a></p><?php
}
