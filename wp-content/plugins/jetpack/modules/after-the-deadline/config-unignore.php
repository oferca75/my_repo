...
function AtD_display_unignore_form()
{
    ...
    <script>
        ...
        function atd_unignore(phrase) {
            ...
            ignored = jQuery.map(ignored, function (value, index) {
                return value == phrase ? null : value;
            });
        ...
        function atd_ignore() {
            ...
            jQuery.map(jQuery('#AtD_add_ignore').val().split(/,\s*/g), function (value, index) {
                ignored.push(value);
            });
    ...
    <p><input type="text" id="AtD_add_ignore" name="AtD_add_ignore"> <input type="button"
                                                                            value="<?php _e('Add', 'jetpack'); ?>"
    ...
    <div class="plugin-update-tr" id="AtD_message" style="display: none">
        <div class="update-message">
            <strong><?php _e('Be sure to click "Update Profile" at the bottom of the screen to save your changes.', 'jetpack'); ?></strong>
        </div>
    </div>
