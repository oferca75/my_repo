...
var ContactPageStep = React.createClass({
    ...
    _renderWithContactPage: function () {
        return (
            <div>
                <p className="welcome__callout welcome__contact--callout welcome__contact-exists--callout">View your
                    starter <a href={ this.state.contactPageURL } target="_blank">Contact Us</a> page.</p>
    ...
    _renderWithoutContactPage: function () {
        return (
            <div className="welcome__contact">
                <p className="welcome__callout welcome__contact--callout welcome__contact-build--callout">Build a <em>starter</em>
                    "Contact Us" page?</p>
