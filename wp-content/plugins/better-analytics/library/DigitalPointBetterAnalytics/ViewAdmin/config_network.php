...
?>
    ...
    <tr valign="top">
        ...
        <td>
            <a id="ba_select_profile" class="button"
               href="<?php echo network_admin_url('settings.php?page=better-analytics_auth'); ?>"><?php
            ...
            <fieldset>
                <label for="ba_api_use_own">
                    <input name="better_analytics[api][use_own]" type="checkbox" id="ba_api_use_own"
                           value="1" <?php checked('1', @$betterAnalyticsSiteOptions['api']['use_own']); ?>>
    ...
    <tr valign="top"
        class="group_api tab_content api_hideable"<?php echo(!@$betterAnalyticsSiteOptions['api']['use_own'] ? ' style="display:none"' : '') ?>>
        <td colspan="2">
    ...
    <tr valign="top"
        ...
        <td>
            <input type="text" name="better_analytics[api][client_id]" id="ba_api_client_id"
                   ...
                   value="<?php echo esc_attr(@$betterAnalyticsSiteOptions['api']['client_id']); ?>"/>
        </td>
    </tr>
    ...
    <tr valign="top"
        ...
        <td>
            <input type="text" name="better_analytics[api][client_secret]" id="ba_api_client_secret"
                   value="<?php echo esc_attr(@$betterAnalyticsSiteOptions['api']['client_secret']); ?>"/>
        </td>
    </tr>
