...
<div id="w3tc-support-us">
    ...
    <header>
        ...
        <div class="right" style="float:right">
            <div style="display: inline-block">
                <iframe height="21" width="100"
                        src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FW3EDGE&amp;width=100&amp;height=21&amp;colorscheme=light&amp;layout=button_count&amp;action=like&amp;show_faces=true&amp;send=false&amp;appId=53494339074"
                        scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;"
                        allowTransparency="true"></iframe>
            </div>
            <div style="display: inline-block; margin-left: 10px;">
                <a href="https://twitter.com/w3edge" class="twitter-follow-button" data-show-count="true"
                   data-show-screen-name="false">Follow @w3edge</a>
            ...
            <div style="display: inline-block; margin-left: 10px;">
                ...
                <div class="g-follow" data-annotation="bubble" data-height="20"
                     data-href="https://plus.google.com/106009620651385224281" data-rel="author"></div>
    ...
    <form action="<?php echo w3_admin_url('admin.php?page=' . $this->_page); ?>&amp;w3tc_config_save_support_us"
          method="post">
        ...
        <div class="content">
                        ...
                        <div class="styled-select">
                            <select name="support" class="w3tc-size select">
                                ...
                                <?php foreach ($supports as $support_id => $support_name): ?>
                                    <option
                                        value="<?php echo esc_attr($support_id); ?>"<?php echo selected($this->_config->get_string('common.support'), $support_id); ?>><?php echo htmlspecialchars($support_name); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </label>
            ...
            <p>
                <label class="w3tc_signup_email" for="email">You can also sign up for our newsletter:<br/>
                    <input id="email" name="email" type="text" class="form-control w3tc-size"
                           value="<?php esc_attr_e($email) ?>"></label><br/>
                <input type="checkbox" name="signmeup" id="signmeup" class="css-checkbox" value="1"
                       checked="checked"/><label for="signmeup"
                                                 class="css-label"> <?php _e('Yes, sign me up.', 'w3-total-cache') ?> </label>
            </p>
        </div>
        <div class="footer">
            <p>
