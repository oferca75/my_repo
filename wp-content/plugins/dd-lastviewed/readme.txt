...
Tags: History, Last, Viewed, posts, custom, posttypes, thumbnail, cookie, widget, recent, visit, visited, recently
...
* Add links on elements

The plugin sets a cookie when visiting the selected single posttypes. This cookie keeps track of those visited IDs.
