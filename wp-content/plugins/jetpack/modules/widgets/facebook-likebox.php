...
class WPCOM_Widget_Facebook_LikeBox extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        <div class="fb-page" data-href="<?php echo esc_url($page_url); ?>"
             data-width="<?php echo intval($like_args['width']); ?>"
             data-height="<?php echo intval($like_args['height']); ?>"
             data-hide-cover="<?php echo esc_attr($like_args['cover']); ?>"
             data-show-facepile="<?php echo esc_attr($like_args['show_faces']); ?>"
             data-show-posts="<?php echo esc_attr($like_args['stream']); ?>">
            <div class="fb-xfbml-parse-ignore">
                <blockquote cite="<?php echo esc_url($page_url); ?>"><a
                        href="<?php echo esc_url($page_url); ?>"><?php echo esc_html($title); ?></a></blockquote>
            </div>
        </div>
        <?php
        wp_enqueue_script('jetpack-facebook-embed');
    ...
    function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('href'); ?>">
                ...
                <input type="text" name="<?php echo $this->get_field_name('href'); ?>"
                       ...
                       value="<?php echo esc_url($like_args['href']); ?>" class="widefat"/>
                <br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('width'); ?>">
                ...
                <input type="number" class="smalltext" min="1" max="999" maxlength="3"
                       name="<?php echo $this->get_field_name('width'); ?>"
                       id="<?php echo $this->get_field_id('width'); ?>"
                       value="<?php echo esc_attr($like_args['width']); ?>" style="text-align: center;"/>px
            </label>
        </p>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('height'); ?>">
                ...
                <input type="number" class="smalltext" min="1" max="999" maxlength="3"
                       ...
                       value="<?php echo esc_attr($like_args['height']); ?>" style="text-align: center;"/>px
            </label>
        </p>

        <p>
            <label for="<?php echo $this->get_field_id('show_faces'); ?>">
                <input type="checkbox" name="<?php echo $this->get_field_name('show_faces'); ?>"
                       id="<?php echo $this->get_field_id('show_faces'); ?>" <?php checked($like_args['show_faces']); ?> />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('stream'); ?>">
                <input type="checkbox" name="<?php echo $this->get_field_name('stream'); ?>"
                       id="<?php echo $this->get_field_id('stream'); ?>" <?php checked($like_args['stream']); ?> />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('cover'); ?>">
                <input type="checkbox" name="<?php echo $this->get_field_name('cover'); ?>"
                       id="<?php echo $this->get_field_id('cover'); ?>" <?php checked($like_args['cover']); ?> />
