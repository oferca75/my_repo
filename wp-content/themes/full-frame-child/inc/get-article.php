           ...
           ?>
            ...
            <ul class="some-facts">
                ...
                if (!is_wp_error($parents) && substr_count($parents, $sep) > 2) {
                    ...
                    ?>
                    <li>
                        A possible path to <strong><?php echo $eTitle; ?></strong> could
                        be <?php echo substr($parents, 0, strlen($parents) - 3);; ?>
                    </li>
                    <?php
                ...
                if ($lastViewedTitle && $lastViewedTitle != "" && $lastViewedTitle != $eTitle) {
                    ...
                    ?>
                    <li>
                        You have arrived to the <strong><?php echo $eTitle; ?></strong> from <a
                            href="<?php echo get_permalink($lastViewedPost); ?>">
                            <?php echo headlineText($lastViewedTitle, "title"); ?>
                        </a>
                    </li>
                    <?php ob_start(); ?>
                    <li>Other options from <strong><?php echo headlineText($lastViewedTitle, "title"); ?></strong> could
                        be:
                        <?php
