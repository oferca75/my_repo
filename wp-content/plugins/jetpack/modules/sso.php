...
class Jetpack_SSO
{
    ...
    function login_footer()
    {
        ...
        <style>
            ...
            .jetpack-sso-wrap {
            <?php if ( $hide_login_form ) : ?> text-align: center;
            <?php else : ?> float: right;
            <?php endif; ?> margin: 1em 0 0;
                clear: right;
                display: block;
            }
            ...
            <tr>
                <td>
                        ...
                        <p><?php echo esc_html($user_data->login); ?></p>
								<span class="two_step">
                                    ...
                                    if ($user_data->two_step_enabled) {
                                        ?> <p class="enabled"><a href="https://wordpress.com/me/security/two-step"
                                                                 target="_blank"><?php _e('Two-Step Authentication Enabled', 'jetpack'); ?></a>
                                        </p> <?php
                                    } else {
                                        ?> <p class="disabled"><a href="https://wordpress.com/me/security/two-step"
                                                                  target="_blank"><?php _e('Two-Step Authentication Disabled', 'jetpack'); ?></a>
                                        </p> <?php
                                    }
                                    ?>
								</span>
                    ...
                    <p><a class="button button-secondary"
                          href="<?php echo esc_url(wp_nonce_url(add_query_arg('jetpack_sso', 'purge'), 'jetpack_sso_purge')); ?>"><?php _e('Unlink This Account', 'jetpack'); ?></a>
                    </p>
                </td>
            </tr>
            </tbody>
    ...
    <?php else : ?>
        ...
        <a href="<?php echo Jetpack::init()->build_connect_url(false, get_edit_profile_url(get_current_user_id()) . '#single-sign-on'); ?>"
