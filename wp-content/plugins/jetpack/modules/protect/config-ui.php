    ...
    <div class="protect-status attn">
        ...
        <form method="post">
            ...
            <p class="submit">
                ...
                <br/><br/><input type='submit' class='button-primary'
                                 value='<?php echo esc_attr(__('Get an API Key', 'jetpack')); ?>'/>
            </p>
        </form>
    </div>
...
<?php else : // api key is good, show white list options ?>
    ...
    <div class="protect-whitelist">
        ...
        <form id="editable-whitelist" method="post">
            ...
            <p>
                <?php _e('Whitelisting an IP address prevents it from ever being blocked by Jetpack. ', 'jetpack'); ?>
                <br/>
