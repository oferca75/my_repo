        ...
        <?php if ($message) : ?>
            <div id="message" class="updated">
                ...
                <?php if ($wp_http_referer) { ?>
                    <p>
                        <a href="<?php echo esc_url($wp_http_referer); ?>"><?php printf(__('&larr; Back to %s'), $tax->labels->name); ?></a>
                    </p>
                <?php } else { ?>
                    <p>
                        <a href="<?php echo esc_url(wp_get_referer()); ?>"><?php printf(__('&larr; Back to %s'), $tax->labels->name); ?></a>
                    </p>
                <?php } ?>
            </div>
        <?php endif; ?>
            ...
            <table class="form-table">
                <tr class="form-field form-required term-name-wrap">
                    ...
                    <td><input name="name" id="name" type="text"
                               value="<?php if (isset($tag->name)) echo esc_attr($tag->name); ?>" size="40"
                               aria-required="true"/>
