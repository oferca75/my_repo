<div class="page-content landing">
    ...
    <?php if ($data['show_jumpstart'] && 'new_connection' === Jetpack_Options::get_option('jumpstart') && current_user_can('jetpack_manage_modules') && !Jetpack::is_development_mode()) : ?>
        ...
        <div id="jump-start-area" class="jump-start-area j-row">
            <h1 title="<?php esc_attr_e('Jump Start your site by activating these components', 'jetpack'); ?>"
                class="jstart"><?php _e('Jump Start your site', 'jetpack'); ?></h1>
            ...
            <div class="jumpstart-message hide">
                <h1 title="<?php esc_attr_e('Your site has been sucessfully Jump Started.', 'jetpack'); ?>"
                    class="success"><?php _e('Success! You\'ve jump started your site.', 'jetpack'); ?></h1>
            ...
            <div id="jumpstart-cta" class="j-col j-sm-12 j-md-12 j-lrg-4">
                <img class="jumpstart-spinner" style="margin: 50px auto 14px; display: none;" width="17" height="17"
                     src="<?php echo esc_url(includes_url('images/spinner-2x.gif')); ?>" alt="Loading ..."/>
    ...
    <?php if ($data['is_connected'] && !$data['is_user_connected'] && current_user_can('jetpack_connect_user')) : ?>
        <div class="link-button" style="width: 100%; text-align: center; margin-top: 15px;">
            <a href="<?php echo Jetpack::init()->build_connect_url() ?>"
               class="download-jetpack"><?php esc_html_e('Link your account to WordPress.com', 'jetpack'); ?></a>
        </div>
    <?php endif; ?>
    ...
    <div class="nux-intro jp-content" style="display: none;">
        ...
        <div class="j-row">
            ...
            <div class="wpcom j-col j-lrg-4 main-col">
                <div class="nux-in">
                    ...
                    <h3 title="<?php esc_attr_e('WordPress.com Tools', 'jetpack'); ?>"><a
                            class="dashicons dashicons-editor-help" href="http://jetpack.com/support/site-management/"
                            title="<?php esc_attr_e('Learn more about WordPress.com\'s free tools', 'jetpack'); ?>"
                            target="_blank"></a><?php _e('WordPress.com Tools', 'jetpack'); ?></h3>
                    ...
                    <div id="manage-row" class="j-row goto <?php echo ($manage_active) ? 'activated' : ''; ?>">
                        <div class="feat j-col j-lrg-7 j-md-8 j-sm-7">
                            <a href="<?php echo esc_url('https://wordpress.com/plugins/' . $normalized_site_url . '?from=jpnux'); ?>"
                               class="button button-primary manage-cta-active" target="_blank"
                               style="display: <?php echo ($manage_active) ? 'inline-block' : 'none'; ?>;"
                               title="<?php esc_attr_e('Go to WordPress.com to try these features', 'jetpack'); ?>"><?php _e('Go to WordPress.com', 'jetpack'); ?></a>
                            <label for="active-manage" class="button button-primary form-toggle manage-cta-inactive"
                                   style="display: <?php echo ($manage_active) ? 'none' : 'inline-block'; ?>"
                                   title="<?php esc_attr_e('Activate free WordPress.com features', 'jetpack'); ?>"><?php _e('Activate features', 'jetpack'); ?></label>
                        </div>
                        <div class="act j-col j-lrg-5 j-md-4 j-sm-5">
                            <div class="module-action">
								<span>
								<?php $manage_active = Jetpack::is_module_active('manage'); ?>
                                    <input class="is-compact form-toggle" type="checkbox"
                                           id="active-manage" <?php echo ($manage_active) ? 'checked' : ''; ?> />
									<label class="form-toggle__label" for="active-manage">
                                        <img class="module-spinner-manage" style="display: none;" width="16" height="16"
        ...
        <?php if (current_user_can('jetpack_manage_modules')) : ?>
            ...
            <p><a href="<?php echo admin_url('admin.php?page=jetpack_modules'); ?>"
                  class="button full-features-btn"><?php echo sprintf(__('See the other %s Jetpack features', 'jetpack'), count(Jetpack::get_available_modules()) - count($data['recommended_list'])); ?></a>
            </p>
        <?php endif; ?>
        ...
        <div class="nux-foot j-row">
            <div class="j-col j-lrg-8 j-md-8 j-sm-12">
                ...
                <ul class="actions">
                    <li><a href="http://jetpack.com/support/" target="_blank"
                           class="button"><?php esc_html_e('Visit support site', 'jetpack'); ?></a></li>
                    <li><a href="https://wordpress.org/support/plugin/jetpack"
                           target="_blank"><?php esc_html_e('Browse forums', 'jetpack'); ?></a></li>
                    <li><a href="http://jetpack.com/contact-support/"
                           target="_blank"><?php esc_html_e('Contact us directly', 'jetpack'); ?></a></li>
                </ul>
            </div>
            <div class="j-col j-lrg-4 j-md-4 j-sm-12">
                ...
                <div class="actions jptracks" data-jptracks-name="nudge_click" data-jptracks-prop="nux-addons"><a
                        href="<?php echo esc_url('https://wordpress.com/plans/' . $normalized_site_url); ?>"
                        target="_blank" class="button"><?php esc_html_e('Compare Options', 'jetpack'); ?></a></div>
            </div>
        </div><?php // nux-foot ?>
...
<?php else : ?>
    ...
    <div class="connection-landing">
        ...
        <div class="connect-card j-row">
            ...
            <div class="connect-btn j-col j-sm-12 j-md-12">
                ...
                <?php if (!$data['is_connected'] && current_user_can('jetpack_connect')) : ?>
                    <a href="<?php echo Jetpack::init()->build_connect_url(false, false, 'landing-page-top') ?>"
                       class="download-jetpack"><?php esc_html_e('Connect Jetpack', 'jetpack'); ?></a>
                <?php elseif ($data['is_connected'] && !$data['is_user_connected'] && current_user_can('jetpack_connect_user')) : ?>
                    <a href="<?php echo Jetpack::init()->build_connect_url(false, false, 'landing-page-top') ?>"
                       class="download-jetpack"><?php esc_html_e('Connect your account', 'jetpack'); ?></a>
                <?php endif; ?>
            </div>
        ...
        <div class="j-traffic feature-container jp-card">
            <header class="first-header j-int">
                ...
                <div class="j-header-img">
                    <img
                        src="<?php echo plugins_url('images/connection-landing/long-clouds.svg', JETPACK__PLUGIN_FILE); ?>"
                        width="1135" height="63"
                        alt="<?php echo esc_attr_x('Jetpack clouds image', 'Image alternative text', 'jetpack'); ?>"/> <?php // must define dimensions here for older IEs ?>
                    <img
                        src="<?php echo plugins_url('images/connection-landing/stat-bars.svg', JETPACK__PLUGIN_FILE); ?>"
                        width="400"
                        alt="<?php echo esc_attr_x('Decorative graph image', 'Image alternative text', 'jetpack'); ?>"/>
                </div>
            </header>
            ...
            <header class="first-header j-int">
                ...
                <div class="j-header-img">
                    <img
                        src="<?php echo plugins_url('images/connection-landing/long-clouds.svg', JETPACK__PLUGIN_FILE); ?>"
                        width="1135" height="63"
                        alt="<?php echo esc_attr_x('Decorative graph image', 'Image alternative text', 'jetpack'); ?>"/> <?php // must define dimensions here for older IEs ?>
                    <img
                        src="<?php echo plugins_url('images/connection-landing/jp-shield.svg', JETPACK__PLUGIN_FILE); ?>"
                        width="180"
                        alt="<?php echo esc_attr_x('Decorative shield image', 'Image alternative text', 'jetpack'); ?>"/>
                </div>
            </header>
        ...
        <div class="connect-card j-row">
            <div class="connect-btn j-col j-sm-12 j-md-12">
                <?php if (!$data['is_connected'] && current_user_can('jetpack_connect')) : ?>
                    <a href="<?php echo Jetpack::init()->build_connect_url(false, false, 'landing-page-bottom') ?>"
                       class="download-jetpack"><?php esc_html_e('Connect Jetpack', 'jetpack'); ?></a>
                <?php elseif ($data['is_connected'] && !$data['is_user_connected'] && current_user_can('jetpack_connect_user')) : ?>
                    <a href="<?php echo Jetpack::init()->build_connect_url() ?>"
                       class="download-jetpack"><?php esc_html_e('Connect your account', 'jetpack'); ?></a>
...
<?php if (Jetpack::is_development_version()) { ?>
    <a id="jump-start-deactivate"
       style="cursor:pointer; display: block; text-align: center; margin-top: 25px;"><?php esc_html_e('RESET EVERYTHING (during testing only) - will reset modules to default as well', 'jetpack'); ?></a>
