            ...
            if ($setting == 'reject_roles'):
                ...
                <div id="<?php echo esc_attr($id) ?>">
                    ...
                    <?php foreach (get_editable_roles() as $role_name => $role_data) : ?>
                        <input <?php disabled(w3_extension_is_sealed('genesis.theme')) ?> type="checkbox"
                ...
                <div id="<?php echo esc_attr($id) ?>">
                    <input <?php disabled(w3_extension_is_sealed('genesis.theme')) ?> type="hidden"
                                                                                      name="<?php echo esc_attr($name) ?>"
                                                                                      value=""/>
                    <?php foreach ($hooks as $hook => $hook_label) : ?>
                        <input <?php disabled(w3_extension_is_sealed('genesis.theme')) ?> type="checkbox"
                                                                                          name="<?php echo esc_attr($name) ?>[]"
                                                                                          value="<?php echo $hook ?>" <?php checked(in_array($hook, $saved_hooks)) ?>
