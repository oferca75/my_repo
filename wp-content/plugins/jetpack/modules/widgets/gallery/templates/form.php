...
<div class="gallery-widget-thumbs-wrapper">
    <div class="gallery-widget-thumbs">
        ...
        foreach ($attachments as $attachment) {
            ...
            <img src="<?php echo esc_url($url); ?>" title="<?php echo esc_attr($attachment->post_title); ?>"
...
<p>
    <a class="button gallery-widget-choose-images"><span
            class="wp-media-buttons-icon"></span> <?php esc_html_e('Choose Images', 'jetpack'); ?></a>
</p>
...
<p class="gallery-widget-link-wrapper">
    ...
    <select name="<?php echo $this->get_field_name('link'); ?>" id="<?php echo $this->get_field_id('link'); ?>"
        ...
        <?php foreach ($allowed_values['link'] as $key => $label) {
            ...
            <option
                value="<?php echo $key; ?>" <?php echo $selected; ?>><?php echo esc_html($label, 'jetpack'); ?></option>
        <?php } ?>
    </select>
</p>
...
<p>
    ...
    ?>
    <input name="<?php echo $this->get_field_name('random'); ?>" id="<?php echo $this->get_field_id('random'); ?>"
...
<p class="gallery-widget-style-wrapper">
    ...
    <select name="<?php echo $this->get_field_name('type'); ?>" id="<?php echo $this->get_field_id('type'); ?>"
            class="widefat gallery-widget-style">
...
<input type="hidden" class="gallery-widget-ids" name="<?php echo $this->get_field_name('ids'); ?>"
       id="<?php echo $this->get_field_id('ids'); ?>" value="<?php echo esc_attr($instance['ids']); ?>"/>
