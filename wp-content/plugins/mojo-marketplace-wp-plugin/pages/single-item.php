                                        ...
                                        <div class="hidden-xs widget text-center" style="border-width: 2px;">
                                            ...
                                            <div class="btn-box">
                                                <a class="btn btn-success btn-lg"
                                                   href="<?php echo mm_build_link(add_query_arg(array('item_id' => $item->id), 'https://www.mojomarketplace.com/cart'), array('utm_medium' => 'plugin_admin', 'utm_content' => 'buy_now_single_bottom')); ?>">Buy
                                                    Now</a>
                                            </div>
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <aside id="sidebar">
                                    <div class="widget text-center">
                                        ...
                                        <div class="btn-box">
                                            <a href="<?php echo mm_build_link(add_query_arg(array('item_id' => $item->id), 'https://www.mojomarketplace.com/cart'), array('utm_medium' => 'plugin_admin', 'utm_content' => 'buy_now_single_sidebar')); ?>"
                                               class="btn btn-success btn-lg"
                                               data-price="<?php echo number_format($item->prices->single_domain_license); ?>"
                                               data-view="single_item">Buy Now</a>
                                        </div>
                                        <span class="price-option">One Time Fee</span>
                                    </div>
                                    <div class="widget">
                                    ...
                                    <?php if ('Professional Services' == $item->type) { ?>
                                        <div class="widget">
                                            ...
                                            <div class="avatar-block">
                                                <div class="avatar"><img class="provider-avatar"
                                                                         src="https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim($item->service_provider->email))); ?>?s=36"/>
                                                </div>
                                                <div
                                                    class="name"><?php echo $item->service_provider->username; ?> </div>
                                            </div>
                                            <i>
                                                <small>Providers are all prescreened and approved.</small>
                                            </i>
                                        </div>
                                    <?php } ?>
                                    <?php
