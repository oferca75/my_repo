    ...
    <div class="metabox-holder">
        ...
        <table class="form-table">
            <tr>
                <th>
                    ...
                    <br/><span
                        class="description"><?php _e('Enabling this option is recommended to maintain default WordPress behavior.', 'w3-total-cache'); ?></span>
                </th>
            </tr>
        </table>
        ...
        <table class="form-table">
            <?php if ($this->_config->get_string('dbcache.engine') == 'memcached'): ?>
                <tr>
                    <th><label for="memcached_servers"><?php w3_e_config_label('dbcache.memcached.servers') ?></label>
                    </th>
                    <td>
                        <input id="memcached_servers" type="text"
                            <?php $this->sealing_disabled('dbcache') ?> name="dbcache.memcached.servers"
                               value="<?php echo esc_attr(implode(',', $this->_config->get_array('dbcache.memcached.servers'))); ?>"
                               size="100"/>
            ...
            <tr>
                <th style="width: 250px;"><label
                        for="dbcache_lifetime"><?php w3_e_config_label('dbcache.lifetime') ?></label></th>
                <td>
                    <input id="dbcache_lifetime" type="text" name="dbcache.lifetime"
                        <?php $this->sealing_disabled('dbcache') ?>
                           value="<?php echo esc_attr($this->_config->get_integer('dbcache.lifetime')); ?>"
            ...
            <tr>
                ...
                <td>
                    <input id="dbcache_file_gc" type="text" name="dbcache.file.gc"
                        <?php $this->sealing_disabled('dbcache') ?>
                           value="<?php echo esc_attr($this->_config->get_integer('dbcache.file.gc')); ?>"
                           size="8"/> <?php _e('seconds', 'w3-total-cache'); ?>
                    <br/><span
            ...
            <tr>
                ...
                <td>
                    <textarea id="dbcache_reject_uri" name="dbcache.reject.uri"
                        <?php $this->sealing_disabled('dbcache') ?> cols="40"
            ...
            <tr>
                ...
                <td>
                    ...
                    <span
                        class="description"><?php _e('Do not cache queries that contain these terms. Any entered prefix (set in wp-config.php) will be replaced with current database prefix (default: wp_). Query stems can be identified using debug mode.', 'w3-total-cache'); ?></span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span
                        class="description"><?php _e('Do not cache queries that contain these words or regular expressions.', 'w3-total-cache'); ?></span>
                </td>
            </tr>
        </table>
