...
<div class="wrap" id="better-analytics_settings">
    ...
    <h3 class="nav-tab-wrapper" id="better-analytics_tabs">
        ...
        <a class="nav-tab" id="dimensions-tab"
           href="#top#dimensions"><?php esc_html_e('Custom Dimensions', 'better-analytics'); ?></a>
        <a class="nav-tab" id="social-tab" href="#top#social"><?php esc_html_e('Social', 'better-analytics'); ?></a>
        <a class="nav-tab" id="advertising-tab"
           href="#top#advertising"><?php esc_html_e('Advertising', 'better-analytics'); ?></a>
        <a class="nav-tab" id="monitor-tab"
           href="#top#monitor"><?php esc_html_e('Monitoring', 'better-analytics'); ?></a>
        <a class="nav-tab" id="ecommerce-tab"
           href="#top#ecommerce"><?php esc_html_e('eCommerce', 'better-analytics'); ?></a>
        <a class="nav-tab" id="api-tab" href="#top#api"><?php esc_html_e('API', 'better-analytics'); ?></a>
        <a class="nav-tab" id="advanced-tab"
           href="#top#advanced"><?php esc_html_e('Advanced', 'better-analytics'); ?></a>
    </h3>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table" id="ba_settings">
            ...
            <tr valign="top" class="group_general tab_content">
                ...
                <td>
                    <input type="text" name="better_analytics[property_id]" id="ba_property_id"
                           placeholder="UA-000000-01" style="width:25%;min-width:110px;"
                           value="<?php echo esc_attr(@$betterAnalyticsOptions['property_id']); ?>"/>
                    <?php
                ...
                <td>
                    <fieldset>
                        <label for="ba_link_attribution">
                            <input name="better_analytics[link_attribution]" type="checkbox" id="ba_link_attribution"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['link_attribution']); ?>>
                        ...
                        <label for="ba_track_userid">
                            <input name="better_analytics[track_userid]" type="checkbox" id="ba_track_userid"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['track_userid']); ?>>
                            <?php esc_html_e('Track Registered Users By User ID', 'better-analytics'); ?></label>
								<span class="dashicons-before dashicons-info tooltip"
                                      title="<?php echo htmlspecialchars(sprintf(__('This feature allows you to utilize %1$ssession unification%2$s within Google Analytics.', 'better-analytics'),
                ...
                <td>
                    <fieldset>
                        <label for="ba_events_user_engagement">
                            <input name="better_analytics[events][user_engagement]" type="checkbox"
                                   id="ba_events_user_engagement"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['user_engagement']); ?>>
                            <?php
                            esc_html_e('User Engagement', 'better-analytics');
                            ?>
                        </label>
						<span class="dashicons-before dashicons-info tooltip"
                              title="<?php echo htmlspecialchars(sprintf(__('This will give you an %1$sadjusted bounce rate%2$s.', 'better-analytics'),
                        ...
                        <label for="ba_events_user_registration">
                            <input name="better_analytics[events][user_registration]" type="checkbox"
                                   id="ba_events_user_registration"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['user_registration']); ?>>
                            <?php esc_html_e('User Registration', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_events_create_comment">
                            <input name="better_analytics[events][create_comment]" type="checkbox"
                                   id="ba_events_create_comment"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['create_comment']); ?>>
                            <?php esc_html_e('Comments Being Created', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_events_youtube">
                            <input name="better_analytics[events][youtube]" type="checkbox" id="ba_events_youtube"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['youtube']); ?>>
                            <?php esc_html_e('YouTube Video Engagement', 'better-analytics'); ?></label>
							<span class="dashicons-before dashicons-info tooltip"
                                  title="<?php echo htmlspecialchars(sprintf(__('This works with the modern IFRAME YouTube embeds.  It does not work with the old OBJECT embeds.%1$sTracks things like video plays, pauses, plays to end, etc.', 'better-analytics'),
                                      '<p />'
                                  )); ?>"></span>
                        ...
                        <label for="ba_events_email">
                            <input name="better_analytics[events][email]" type="checkbox" id="ba_events_email"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['email']); ?>>
                            <?php esc_html_e('Emails Sent/Opened', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_events_link_click">
                            <input name="better_analytics[events][link_click]" type="checkbox" id="ba_events_link_click"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['link_click']); ?>>
                            <?php esc_html_e('Clicks On External Links', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_events_downloads">
                            <input name="better_analytics[events][downloads]" type="checkbox" id="ba_events_downloads"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['downloads']); ?>>
                            <?php esc_html_e('File Downloads', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_events_page_scroll">
                            <input name="better_analytics[events][page_scroll]" type="checkbox"
                                   id="ba_events_page_scroll"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['page_scroll']); ?>>
                            <?php esc_html_e('Page Scroll Percent', 'better-analytics'); ?></label>
                        <span class="dashicons-before dashicons-info tooltip"
                              title="<?php esc_attr_e('This is the percent of the page the user scrolled down to view before leaving the page.', 'better-analytics'); ?>"></span>
                        <br/>

                        <label for="ba_events_time_on_page">
                            <input name="better_analytics[events][time_on_page]" type="checkbox"
                                   id="ba_events_time_on_page"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['time_on_page']); ?>>
                            <?php esc_html_e('Time On Page', 'better-analytics'); ?></label>
                        <span class="dashicons-before dashicons-info tooltip"
                              title="<?php esc_attr_e('This is the amount of time (recorded in seconds) that the user spent on the individual page.', 'better-analytics'); ?>"></span>
                ...
                <td>
                    <fieldset>
                        <label for="ba_anonymize_ips">
                            <input name="better_analytics[anonymize_ips]" type="checkbox" id="ba_anonymize_ips"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['anonymize_ips']); ?>>
                            <?php esc_html_e('Anonymize IPs', 'better-analytics'); ?></label>
						<span class="dashicons-before dashicons-info tooltip"
                              title="<?php echo htmlspecialchars(sprintf(__('Detailed information about IP Anonymization in Google Analytics can be found %1$sover here%2$s.', 'better-analytics'),
                        ...
                        <label for="ba_demographic_tracking">
                            <input name="better_analytics[demographic_tracking]" type="checkbox"
                                   id="ba_demographic_tracking"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['demographic_tracking']); ?>>
                            <?php esc_html_e('Demographic & Interest Tracking', 'better-analytics'); ?></label>
						<span class="dashicons-before dashicons-info tooltip"
                              title="<?php echo htmlspecialchars(sprintf(__('This allows you to view extra dimensions about users (Age, Gender, Affinity Categories, In-Market Segments and Other Categories.%1$sThis requires enabling the option in your %2$sGoogle Analytics account%3$s under %4$sProperty Settings%5$s.', 'better-analytics'),
                                  '<p />',
                        ...
                        <label for="ba_force_ssl">
                            <input name="better_analytics[force_ssl]" type="checkbox" id="ba_force_ssl"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['force_ssl']); ?>>
                            <?php esc_html_e('Force Analytics Traffic Over SSL', 'better-analytics'); ?></label>
						<span class="dashicons-before dashicons-info tooltip"
                              title="<?php echo htmlspecialchars(sprintf(__('If your site is HTTPS based, Analytics traffic will always go over SSL.  If you have an insecure site, but wish Analytics traffic to still be secure, use this option.  Additionally, SSL traffic is going to be generally faster because it\'s able to utilize the %1$sSPDY protocol%2$s.', 'better-analytics'),
                ...
                <td>
                    <fieldset>
                        <label for="ba_souce_link_rss">
                            <input name="better_analytics[source_link][rss]" type="checkbox" id="ba_souce_link_rss"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['source_link']['rss']); ?>>
                            <?php esc_html_e('RSS', 'better-analytics'); ?></label>
                        <span class="dashicons-before dashicons-info tooltip"
                              title="<?php esc_html_e('Links within RSS feed will be tagged to track the source/medium as being RSS.', 'better-analytics'); ?>"></span>
                        <br/>

                        <label for="ba_souce_link_email">
                            <input name="better_analytics[source_link][email]" type="checkbox" id="ba_souce_link_email"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['source_link']['email']); ?>>
                            <?php esc_html_e('Email', 'better-analytics'); ?></label>
                        <span class="dashicons-before dashicons-info tooltip"
                              title="<?php esc_html_e('Links within RSS feed will be tagged to track the source/medium as being Email.', 'better-analytics'); ?>"></span>
                ...
                <td>
                    ...
                    <fieldset>
                        <label for="ba_social_facebook">
                            <input name="better_analytics[social][facebook]" type="checkbox" id="ba_social_facebook"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['social']['facebook']); ?>>
                            <?php esc_html_e('Facebook Like', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_social_twitter">
                            <input name="better_analytics[social][twitter]" type="checkbox" id="ba_social_twitter"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['social']['twitter']); ?>>
                            <?php esc_html_e('Twitter', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_social_google">
                            <input type="checkbox" id="ba_social_google" value="1" checked="checked"
                                   disabled="disabled">
                            <?php esc_html_e('Google+ (Google Analytics always tracks)', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_social_pinterest">
                            <input name="better_analytics[social][pinterest]" type="checkbox" id="ba_social_pinterest"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['social']['pinterest']); ?>>
                            <?php esc_html_e('Pinterest', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_social_linkedin">
                            <input name="better_analytics[social][linkedin]" type="checkbox" id="ba_social_linkedin"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['social']['linkedin']); ?>>
            ...
            <tr valign="top" class="group_advertising tab_content">
                ...
                <td>
                    ...
                    <fieldset>
                        <label
                            for="ba_ads_adsense"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[ads][adsense]" type="checkbox" id="ba_ads_adsense"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['ads']['adsense']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('AdSense', 'better-analytics'); ?></label>
                        <br/>

                        <label
                            for="ba_ads_outbrain"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[ads][outbrain]" type="checkbox" id="ba_ads_outbrain"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['ads']['outbrain']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('Outbrain', 'better-analytics'); ?></label>
                        <br/>

                        <label
                            for="ba_ads_revcontent"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[ads][revcontent]" type="checkbox" id="ba_ads_revcontent"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['ads']['revcontent']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('RevContent', 'better-analytics'); ?></label>
                        <br/>

                        <label
                            for="ba_ads_taboola"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[ads][taboola]" type="checkbox" id="ba_ads_taboola"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['ads']['taboola']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('Taboola', 'better-analytics'); ?></label>
                        <br/>

                        <label for="ba_ads_digitalpoint">
                            <input name="better_analytics[ads][digitalpoint]" type="checkbox" id="ba_ads_digitalpoint"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['ads']['digitalpoint']); ?>>
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="ba_events_error_404">
                            <input name="better_analytics[events][error_404]" type="checkbox" id="ba_events_error_404"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['error_404']); ?>>
                            <?php esc_html_e('Page Not Found (404)', 'better-analytics'); ?></label>
                        <br/>

                        <label
                            for="ba_events_missing_images"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[events][missing_images]" type="checkbox"
                                   id="ba_events_missing_images"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['missing_images']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('Images Not Loading', 'better-analytics'); ?>
                            <span class="dashicons-before dashicons-info tooltip"
                                  title="<?php esc_html_e('This relies on the ability of the user\'s browser to load images which will vary between browsers and Internet connections.  This event can be a useful tool for finding missing images, but it keep in mind it will log any image that the end user\'s browser did not load (for any reason).', 'better-analytics'); ?>"></span>
                        </label>
                        <br/>

                        <label
                            for="ba_events_errors_javascript"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[events][error_js]" type="checkbox"
                                   id="ba_events_errors_javascript"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['error_js']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('JavaScript Errors', 'better-analytics'); ?></label>
                        <br/>

                        <label
                            for="ba_events_errors_ajax"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[events][error_ajax]" type="checkbox"
                                   id="ba_events_errors_ajax"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['error_ajax']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('AJAX Errors', 'better-analytics'); ?></label>
                        <br/>
                        <label
                            for="ba_events_errors_console"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[events][error_console]" type="checkbox"
                                   id="ba_events_errors_console"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['error_console']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('Browser Console Errors', 'better-analytics'); ?></label>
                        <br/>
                        <label
                            for="ba_events_errors_youtube"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[events][error_youtube]" type="checkbox"
                                   id="ba_events_errors_youtube"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['error_youtube']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php esc_html_e('YouTube Errors', 'better-analytics'); ?>
                            <span class="dashicons-before dashicons-info tooltip"
                                  title="<?php esc_html_e('This allows you to quickly find old videos that the author has removed or disabled embeding for.', 'better-analytics'); ?>"></span>
                        </label>
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="ba_events_ajax_requests">
                            <input name="better_analytics[events][ajax_request]" type="checkbox"
                                   id="ba_events_ajax_requests"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['events']['ajax_request']); ?>>
            ...
            <tr valign="top" class="group_ecommerce tab_content">
                ...
                <td>
                    <fieldset>
                        <label
                            for="ba_ecommerce_woo"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                            <input name="better_analytics[ecommerce][woo]" type="checkbox" id="ba_ecommerce_woo"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['ecommerce']['woo']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                            <?php
            ...
            <tr valign="top" class="group_api tab_content">
                ...
                <td>
                    ...
                    if (get_site_option('ba_site_tokens') && get_site_option('ba_site_tokens') != get_option('ba_tokens')) {
                        ...
                        <a id="ba_select_profile" class="button"
                           href="<?php menu_page_url('better-analytics_auth'); ?>"><?php
            ...
            <tr valign="top" class="group_advanced tab_content">
                <th scope="row"><?php esc_html_e('Roles To Not Track', 'better-analytics'); ?> <span
                        class="dashicons-before dashicons-info tooltip"
                        title="<?php esc_html_e('If a logged in user is part of one of these groups, Analytics will not track them.', 'better-analytics'); ?>"></span>
                </th>
                <td>

                    <select data-placeholder="<?php esc_html_e('Pick roles to not track', 'better-analytics'); ?>"
                            id="ba_roles_no_track" name="better_analytics[roles_no_track][]" multiple
                            class="chosen-select">
                        <option value=""></option>
            ...
            <tr valign="top" class="group_advanced tab_content">
                ...
                <td>
                    ...
                    <select
                        data-placeholder="<?php esc_html_e('Pick roles that are able to view reports', 'better-analytics'); ?>"
                        id="ba_roles_view_reports" name="better_analytics[roles_view_reports][]" multiple
                        class="chosen-select">
                        <option value=""></option>
                    ...
                    <fieldset style="padding-top:3px;">
                        <label for="ba_author_view_reports">
                            <input name="better_analytics[author_view_reports]" type="checkbox"
                                   id="ba_author_view_reports"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['author_view_reports']); ?>>
                ...
                <td>
                    <fieldset>
                        <label for="ba_lock_settings_user_id">
                            <input name="better_analytics[lock_settings_user_id]" type="checkbox"
                                   id="ba_lock_settings_user_id"
                                   value="<?php echo @$currentUser->ID; ?>" <?php checked('1', @$betterAnalyticsOptions['lock_settings_user_id']); ?>>
                            <?php esc_html_e('Only Your User Account', 'better-analytics'); ?></label>
                        <span class="dashicons-before dashicons-info tooltip"
                              title="<?php esc_html_e('If you want to disable all other admin accounts from having access to the Better Analytics settings, use this option.  Keep in mind, that only your account will have access to change any Better Analytics settings.', 'better-analytics'); ?>"></span>
            ...
            <tr valign="top" class="group_advanced tab_content">
                <th scope="row"><?php esc_html_e('File Extensions To Track As Downloads', 'better-analytics'); ?> <span
                        class="dashicons-before dashicons-info tooltip"
                        title="<?php esc_html_e('If a logged in user is part of one of these groups, Analytics will not track them.', 'better-analytics'); ?>"></span>
                </th>
                <td>
                    <select data-placeholder="<?php esc_html_e('Pick file extensions', 'better-analytics'); ?>"
                            id="ba_file_extensions" name="better_analytics[file_extensions][]" multiple
                            class="chosen-select">
                        <option value=""></option>
            ...
            <tr valign="top" class="group_advanced tab_content">
                <th scope="row"><?php esc_html_e('Track Users With Analytics Blockers', 'better-analytics'); ?> <span
                        class="dashicons-before dashicons-info tooltip" title="<?php
                ...
                <td>
                    <fieldset
                        id="ba_track_blocked"<?php echo(!intval(@$betterAnalyticsInternal) ? ' class="pro"' : ''); ?>>
                        <label>
                            <input name="better_analytics[track_blocked]" type="radio"
                                   value="never" <?php checked('never', @$betterAnalyticsOptions['track_blocked']); ?>>
                            <?php esc_html_e('Never', 'better-analytics'); ?></label>
                        <br/>

                        <label>
                            <input name="better_analytics[track_blocked]" type="radio"
                                   value="logged_in" <?php checked('logged_in', @$betterAnalyticsOptions['track_blocked']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                        ...
                        <label>
                            <input name="better_analytics[track_blocked]" type="radio"
                                   value="humans" <?php checked('humans', @$betterAnalyticsOptions['track_blocked']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
                        ...
                        <label>
                            <input name="better_analytics[track_blocked]" type="radio"
                                   value="everything" <?php checked('everything', @$betterAnalyticsOptions['track_blocked']);
                            disabled(0, intval(@$betterAnalyticsInternal)); ?>>
            ...
            <tr valign="top" class="group_advanced tab_content">
                ...
                <td>
                    <fieldset id="ba_javascript_location">
                        <label>
                            <input name="better_analytics[javascript][location]" type="radio"
                                   value="header" <?php checked('header', @$betterAnalyticsOptions['javascript']['location']); ?>>
                            <?php esc_html_e('Header', 'better-analytics'); ?></label>
                        <br/>

                        <label>
                            <input name="better_analytics[javascript][location]" type="radio"
                                   value="footer" <?php checked('footer', @$betterAnalyticsOptions['javascript']['location']); ?>>
                            <?php esc_html_e('Footer', 'better-analytics'); ?></label>
                        <br/>

                        <label>
                            <input name="better_analytics[javascript][location]" type="radio"
                                   value="none" <?php checked('none', @$betterAnalyticsOptions['javascript']['location']); ?>>
                            <?php esc_html_e('No JavaScript (you have your own/other already)', 'better-analytics'); ?>
                        </label>


                        <br/>
                        <label for="ba_use_in_admin">
                            <input name="better_analytics[javascript][use_in_admin]" type="checkbox"
                                   id="ba_use_in_admin"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['javascript']['use_in_admin']); ?>>
            ...
            <tr valign="top" class="group_advanced tab_content">
                ...
                <td>
                    <fieldset id="ba_javascript_run_time">
                        <label>
                            <input name="better_analytics[javascript][run_time]" type="radio"
                                   value="immediately" <?php checked('immediately', @$betterAnalyticsOptions['javascript']['run_time']); ?>>
                            <?php esc_html_e('Immediately', 'better-analytics'); ?></label>
                        <br/>

                        <label>
                            <input name="better_analytics[javascript][run_time]" type="radio"
                                   value="ready" <?php checked('ready', @$betterAnalyticsOptions['javascript']['run_time']); ?>>
            ...
            <tr valign="top" class="group_advanced tab_content">
                ...
                <td>
                    <fieldset id="ba_javascript_campaign_tracking">
                        <label>
                            <input name="better_analytics[campaign_tracking]" type="radio"
                                   value="anchor" <?php checked('anchor', @$betterAnalyticsOptions['campaign_tracking']); ?>>
                            <?php esc_html_e('In Anchor', 'better-analytics'); ?></label>
                        <br/>

                        <label>
                            <input name="better_analytics[campaign_tracking]" type="radio"
                                   value="params" <?php checked('params', @$betterAnalyticsOptions['campaign_tracking']); ?>>
            ...
            <tr valign="top" class="group_advanced tab_content">
                <th scope="row"><?php esc_html_e('Sample Rate', 'better-analytics'); ?> <span
                        class="dashicons-before dashicons-info tooltip"
                        title="<?php esc_html_e('Specifies what percentage of users should be tracked.  Very large sites may need to use a lower sample rate to stay within Google Analytics processing limits.', 'better-analytics'); ?>"></span>
                </th>
                <td>
                        ...
                        <div style="display:table">
                            <div style="display:table-row">
                                <div style="display:table-cell">
                                    <input type="number" name="better_analytics[sample_rate]" id="ba_sample_rate"
                                           min="1" max="100" step="1"
                                           value="<?php echo esc_attr(intval(@$betterAnalyticsOptions['sample_rate']) >= 1 && intval(@$betterAnalyticsOptions['sample_rate']) <= 100 ? intval(@$betterAnalyticsOptions['sample_rate']) : 100); ?>"/>
                                    %
                                </div>
                            </div>
                        </div>
            ...
            <tr valign="top" class="group_advanced tab_content">
                <th scope="row"><?php esc_html_e('User Engagement Time', 'better-analytics'); ?> <span
                        class="dashicons-before dashicons-info tooltip"
                        title="<?php esc_html_e('This is the time (in seconds) before we consider the user "engaged".  This setting only applies if you use the "User Engagement" event tracking (under General tab).', 'better-analytics'); ?>"></span>
                </th>
                <td>
                    ...
                    <fieldset>
                        <div style="display:table">
                            <div style="display:table-row">
                                <div style="display:table-cell">
                                    <input type="number" name="better_analytics[engagement_time]"
                                           id="ba_engagement_time" min="1" max="600" step="1"
                                           value="<?php echo esc_attr(intval(@$betterAnalyticsOptions['engagement_time']) >= 1 && intval(@$betterAnalyticsOptions['engagement_time']) <= 600 ? intval(@$betterAnalyticsOptions['engagement_time']) : 15); ?>"/> <?php esc_html_e('seconds', 'better-analytics'); ?>
                                </div>
                            </div>
                        </div>
                    </fieldset>
            ...
            <tr valign="top" class="group_advanced tab_content">
                <th scope="row"><?php esc_html_e('Extra JavaScript', 'better-analytics'); ?> <span
                        class="dashicons-before dashicons-info tooltip"
                        title="<?php echo htmlspecialchars(sprintf(__('This allows you to add your own JavaScript code to the Analytics tracking code.  This JavaScript is inserted right before the %1$s function.', 'better-analytics'), '<strong>ga(\'send\', \'pageview\');</strong>')); ?>"></span>
                </th>
                <td>
                    <textarea name="better_analytics[extra_js]" rows="10" cols="50" id="ba_extra_js"
                              class="large-text code"><?php echo esc_textarea(@$betterAnalyticsOptions['extra_js']); ?></textarea>
                </td>
            </tr>
                ...
                <td>
                    <fieldset>
                        <label for="ba_debugging">
                            <input name="better_analytics[debugging]" type="checkbox" id="ba_debugging"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['debugging']); ?>>
                            <?php esc_html_e('Enable Google Analytics Debugging', 'better-analytics'); ?></label>
                        <span class="dashicons-before dashicons-info tooltip"
                              title="<?php esc_html_e('This will display Google Analytics debug data in the browser console.', 'better-analytics'); ?>"></span>
                ...
                <td>
                    <fieldset>
                        <label for="ba_hide_api_message">
                            <input name="better_analytics[hide_api_message]" type="checkbox" id="ba_hide_api_message"
                                   value="1" <?php checked('1', @$betterAnalyticsOptions['hide_api_message']); ?>>
                            <?php esc_html_e('Hide "API Not Linked" Notice', 'better-analytics'); ?></label>
                        <span class="dashicons-before dashicons-info tooltip"
                              title="<?php esc_html_e('If you choose not to link your Google Analytics account for reporting and management, you can disable the notice about it with this option (the notice will still show on Better Analytics config/reporting pages).', 'better-analytics'); ?>"></span>
