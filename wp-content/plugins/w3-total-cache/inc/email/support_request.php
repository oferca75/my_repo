...
<p>
    ...
    <?php if ($twitter): ?>
        Twitter: <a
            href="http://twitter.com/<?php echo esc_attr($twitter); ?>"><?php echo htmlspecialchars($twitter); ?></a>
        <br/>
    <?php endif; ?>
    ...
    <?php if ($forum_url): ?>
        Forum Topic URL: <a href="<?php echo esc_attr($forum_url); ?>"><?php echo htmlspecialchars($forum_url); ?></a>
        <br/>
    <?php endif; ?>

    <?php if ($request_data_url): ?>
        Request data: <a
            href="<?php echo esc_attr($request_data_url); ?>"><?php echo htmlspecialchars($request_data_url); ?></a>
        <br/>
    <?php endif; ?>
