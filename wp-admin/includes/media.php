...
function edit_form_image_editor($post)
{
    ...
    <div class="wp_attachment_holder wp-clearfix">
        ...
        if (wp_attachment_is_image($post->ID)) :
            ...
            <div<?php if ($open) echo ' style="display:none"'; ?> class="wp_attachment_image wp-clearfix"
            ...
            <div<?php if (!$open) echo ' style="display:none"'; ?> class="image-editor"
    ...
    <div class="wp_attachment_details edit-form-section">
        ...
        <?php if ('image' === substr($post->post_mime_type, 0, 5)) : ?>
            <p>
                ...
                <input type="text" class="widefat" name="_wp_attachment_image_alt" id="attachment_alt"
