...
function jetpack_mobile_css_settings()
{
    ...
    <div class="misc-pub-section">
        ...
        <div id="mobile-css-select" class="hide-if-js">
            ...
            <p>
                <a class="save-mobile-css hide-if-no-js button"
                   href="#mobile-css"><?php esc_html_e('OK', 'jetpack'); ?></a>
                <a class="cancel-mobile-css hide-if-no-js"
                   href="#mobile-css"><?php esc_html_e('Cancel', 'jetpack'); ?></a>
            </p>
        </div>
    </div>
    <script type="text/javascript">
