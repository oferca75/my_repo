<?php
/**
 * Almost all of the below code belongs to 'Get the Image' WordPress plugin by Justin Tadlock. This is the perfect code for extracting post images, I have just changed the function * names specific to Related Posts Slider, as someone would like to use the 'Get the Image' WordPress plugin separately.
...
add_action('save_post', 'cf5_rps_get_the_image_delete_cache');
add_action('deleted_post_meta', 'cf5_rps_get_the_image_delete_cache');
add_action('updated_post_meta', 'cf5_rps_get_the_image_delete_cache');
add_action('added_post_meta', 'cf5_rps_get_the_image_delete_cache');
 ...
 * is found, call cf5_rps_display_the_image() to format it.
 *
 * @since 0.1
...
function cf5_rps_get_the_image($args = array())
{
    ...
    $args = apply_filters('cf5_rps_get_the_image_args', $args);
    ...
    $cache = wp_cache_get('cf5_rps_get_the_image');
 ...
 * @return array|bool
 */
function cf5_rps_image_by_custom_field($args = array())
{
 ...
 * other filters are later added in the cf5_rps_display_the_image() function.
 *
 * @since 0.4
 * @param array $args
 * @return array|bool
 */
function cf5_rps_image_by_the_post_thumbnail($args = array())
{
 ...
 * @return array|bool
 */
function cf5_rps_image_by_attachment($args = array())
{
...
/**
 * Scans the post for images within the content.  Not called by default with cf5_rps_get_the_image().
 ...
 * @return array|bool
 */
function cf5_rps_image_by_scan($args = array())
{
    ...
    if (isset($matches)) {
        if (isset($matches[1][0])) return array('url' => $matches[1][0]);
    }
 ...
 * given in an array.  Not used with cf5_rps_get_the_image() by default.
 *
 * @since 0.3
 * @param array $args
 * @return array
 */
function cf5_rps_image_by_default($args = array())
{
 ...
 */
function cf5_rps_display_the_image($args = array(), $image = false)
{
 ...
 * @since 0.5
 */
function cf5_rps_get_the_image_delete_cache()
{
    wp_cache_delete('cf5_rps_get_the_image');
}

/**
 * Get the image with a link to the post.  Use cf5_rps_get_the_image() instead.
 *
 * @since 0.1
 * @deprecated 0.3
 */
function cf5_rps_get_the_image_link($deprecated = '', $deprecated_2 = '', $deprecated_3 = '')
{
    cf5_rps_get_the_image();
}
