...
class Wikipedia_Widget extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        <form action="" method="GET" class="<?php echo $this->id_base; ?>-search_form">
            ...
            <div class="<?php echo $this->id_base; ?>-loader" style="display:none"><img
                    src="<?php echo plugins_url('/loader.gif', __FILE__); ?>"/></div>
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input type="text" class="widefat" name="<?php echo $this->get_field_name('title'); ?>"
                   value="<?php echo esc_attr($title); ?>" id="<?php echo $this->get_field_id('title'); ?>"/>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('wikipedia_url'); ?>"><?php _e('Wikipedia URL:'); ?></label>
            <input type="url" class="widefat" list="<?php echo $this->get_field_id('wikipedia_urls'); ?>"
                   id="<?php echo $this->get_field_id('wikipedia_url'); ?>"
                   name="<?php echo $this->get_field_name('wikipedia_url'); ?>"
                   id="<?php echo $this->get_field_id('wikipedia_url'); ?>"
                   value="<?php echo esc_attr($wikipedia_url); ?>" required/>
        ...
        <p>
            ...
            <input type="number" name="<?php echo $this->get_field_name('limit'); ?>"
                   value="<?php echo esc_attr($limit); ?>" size="3" id="<?php echo $this->get_field_id('limit'); ?>"/>
        </p>
        <p>
            <input <?php checked($search_form, 'on'); ?> class="checkbox" type="checkbox"
                                                         id="<?php echo $this->get_field_id('search_form'); ?>"
                                                         name="<?php echo $this->get_field_name('search_form'); ?>"/>
            <label for="<?php echo $this->get_field_id('search_form'); ?>"><?php _e('Show search form'); ?></label>
        </p>
        <p>
            <label
                for="<?php echo $this->get_field_id('search_term'); ?>"><?php _e('Search at categories/pages:'); ?></label>
            <input type="text" class="widefat" name="<?php echo $this->get_field_name('search_term'); ?>"
                   id="<?php echo $this->get_field_id('search_term'); ?>" value="<?php echo $search_term; ?>"
                   placeholder="<?php _e('Default search string'); ?>"/>
        </p>
        <p>
            <label
                for="<?php echo $this->get_field_id('search_field_alt'); ?>"><?php _e('Alternative search-field:'); ?></label>
            <input type="text" class="widefat" name="<?php echo $this->get_field_name('search_field_alt'); ?>"
                   id="<?php echo $this->get_field_id('search_field_alt'); ?>" value="<?php echo $search_field_alt; ?>"
                   placeholder="id or class" title="example: #my-input-form"/>
        </p>
    <?php }
