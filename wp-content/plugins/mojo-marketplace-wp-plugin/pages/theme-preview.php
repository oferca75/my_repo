        ...
        <div class="wp-full-overlay expanded" id="theme-installer" style="display: block;">
            <div class="wp-full-overlay-sidebar">
                <div class="wp-full-overlay-header">
                    <a href="<?php echo esc_url(add_query_arg(array('page' => 'mojo-themes', 'items' => esc_attr($items)), admin_url('admin.php'))); ?>"
                       class="theme-preview-close">
                        <span class="pull-right dashicons dashicons-no-alt"></span>
                    </a>
                </div>
                <div class="wp-full-overlay-sidebar-content">
                    <img class="theme-preview-logo"
                         src="<?php echo mm_brand(MM_ASSETS_URL . 'img/logo-preview-%s.svg'); ?>"/>
                        ...
                        <div class="theme-details text-center">
                            <div role="group" class="btn-group-horizontal">
                                <a class="btn btn-primary"
                                   href="<?php echo esc_url(add_query_arg(array('page' => 'mojo-single-item', 'item_id' => $item_id), admin_url('admin.php'))); ?>">Details</a>
                                <a class="btn btn-success"
                                   href="<?php echo mm_build_link(add_query_arg(array('item_id' => $item_id), 'https://www.mojomarketplace.com/cart'), array('utm_medium' => 'plugin_admin', 'utm_content' => 'buy_now_preview')); ?>">Buy
                                    Now</a>
                            </div>
                            <br/>
                            <div class="price">
                            ...
                            <div class="row">
                                ...
                                for ($i = 0; $i < 3; $i++) {
                                    ...
                                    <div class="col-md-4"><a
                                            data-preview="<?php echo $other_items[$i]->images->preview_url; ?>"
                                            class="theme-preview-other-link"
                                            href="<?php echo add_query_arg(array('id' => $other_items[$i]->id)); ?>"><img
                                                class="theme-preview-other-themes"
                                                src="<?php echo $other_items[$i]->images->square_thumbnail_url; ?>"/></a>
                                    </div>
                                    <?php
                                }
                                ?>
            ...
            <div class="wp-full-overlay-main">
                <iframe
                    src="<?php echo mm_build_link($theme->demo_url, array('utm_medium' => 'plugin_admin', 'utm_content' => 'preview_view_demo')); ?>"></iframe>
            </div>
        </div>
