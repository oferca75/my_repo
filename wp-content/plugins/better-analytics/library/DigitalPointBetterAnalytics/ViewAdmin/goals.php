        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="name" class="regular-text" id="ba_name"
                           value="<?php echo esc_attr(@$goal['name']); ?>" required/>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    <fieldset>
                        <label for="ba_active">
                            <input name="active" type="checkbox" id="ba_active"
                                   value="1" <?php checked('1', (@$goal ? @$goal['active'] : '1')); ?>>
            ...
            <tr valign="top">
                <th scope="row"><?php esc_html_e('Value', 'better-analytics'); ?><span
                        class="optional"><?php esc_html_e('Optional', 'better-analytics'); ?></span></th>
                <td>
                    <input type="number" name="value" id="ba_value" min="0" step="0.01"
                           value="<?php echo number_format(@$goal['value'], 2); ?>"/>
                </td>
            </tr>
            ...
            <tr valign="top" class="dynamic_options URL_DESTINATION">
                ...
                <td>
                    ...
                    <input type="text" name="destination_url" class="regular-text" id="ba_destination_url"
                           placeholder="<?php echo esc_attr(esc_html__('URL', 'better-analytics')); ?>"
                           value="<?php echo esc_attr(@$goal['urlDestinationDetails']['url']); ?>"/>

                    <label for="ba_case_sensitive">
                        <input name="case_sensitive" type="checkbox" id="ba_case_sensitive"
                               value="1" <?php checked('1', (@$goal['urlDestinationDetails']['caseSensitive'] ? '1' : '')); ?>>
            ...
            <tr valign="top" class="dynamic_options VISIT_TIME_ON_SITE">
                ...
                <td>
                    ...
                    <div>
                        ...
                        <div>
                            <span
                                style="padding-right:5px;"><?php esc_html_e('Greater than', 'better-analytics') ?></span>
							<span>
								<input type="number" name="hours" min="0" id="ba_hours"
                                       value="<?php echo esc_attr((absint($durations[0] - 1) * 24) + absint($durations[1])); ?>"/>
							</span>
							<span>
								<input type="number" name="minutes" min="0" id="ba_minutes"
                                       value="<?php echo esc_attr(absint($durations[2])); ?>"/>
							</span>
							<span>
								<input type="number" name="seconds" min="0" id="ba_seconds"
                                       value="<?php echo esc_attr(absint($durations[3])); ?>"/>
							</span>
                        </div>
                    </div>
                </td>
                    ...
                    <div>
                        <div>
                            <span
                                style="padding-right:5px;"><?php esc_html_e('Greater than', 'better-analytics') ?></span>
							<span>
								<input type="number" name="pages" min="0" id="ba_pages"
                                       value="<?php echo esc_attr(absint(@$goal['visitNumPagesDetails']['comparisonValue'])); ?>"/>
							</span>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    ...
                    <fieldset>
                        <label for="ba_use_event_value">
                            <input name="use_event_value" type="checkbox" id="ba_use_event_value"
                                   value="1" <?php checked('1', (@$goal['eventDetails']['useEventValue'] ? '1' : '')); ?>>
                            <?php esc_html_e('Use the Event value as the Goal Value for the conversion', 'better-analytics'); ?>
                        </label>
                    </fieldset>
