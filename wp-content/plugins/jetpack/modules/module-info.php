...
function vaultpress_jetpack_more_info()
{
    ...
    <div class="jp-info-img">
        <a href="<?php echo $vaultpress_url ?>" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/vaultpress.jpg') ?>"
                 alt="<?php esc_attr_e('VaultPress', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <a href="http://blog.gravatar.com/2010/10/06/gravatar-hovercards-on-wordpress-com/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/hovercards.jpg') ?>"
                 alt="<?php esc_attr_e('Gravatar Hovercard', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <a href="http://en.support.wordpress.com/shortcodes/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/shortcodes.jpg') ?>"
                 alt="<?php esc_attr_e('Shortcode Embeds', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <a href="http://wp.me/sf2B5-shorten" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/shortlinks.jpg') ?>"
                 alt="<?php esc_attr_e('WP.me Shortlinks', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <a href="http://en.support.wordpress.com/stats/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/stats.jpg') ?>"
                 alt="<?php esc_attr_e('Site Stats', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <a href="http://en.support.wordpress.com/publicize/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/publicize.jpg') ?>"
                 alt="<?php esc_attr_e('Publicize', 'jetpack') ?>" width="328" height="123"/>
        </a>
    </div>
...
<?php endif; ?>
    ...
    <p>&rarr; <a href="http://jetpack.com/support/publicize/"
                 target="_blank"><?php esc_html_e('More information on using Publicize.', 'jetpack'); ?></a></p>
    <?php
}
...
{ ?>
    <div class="jp-info-img">
        <a href="http://support.wordpress.com/notifications/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/notes.jpg') ?>"
                 alt="<?php esc_attr_e('Notifications', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <a href="http://support.wordpress.com/latex/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/beautifulmath.jpg') ?>"
                 alt="<?php esc_attr_e('LaTeX', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <embed type="application/x-shockwave-flash" src="http://s0.videopress.com/player.swf?v=1.02" height="190"
               wmode="transparent" seamlesstabbing="true" allowfullscreen="true" allowscriptaccess="always"
               overstretch="true" flashvars="guid=WV0JOwY2"></embed>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <a href="http://en.support.wordpress.com/proofreading/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/spelling.jpg') ?>"
                 alt="<?php esc_attr_e('Spelling and Grammar', 'jetpack') ?>" width="300" height="150"/>
        </a>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/widgets.jpg') ?>"
             alt="<?php esc_attr_e('Widgets Screenshot', 'jetpack') ?>" width="300" height="150"/>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/subscriptions.jpg') ?>"
             alt="<?php esc_attr_e('Subsriptions Screenshot', 'jetpack') ?>" width="300" height="150"/>
    </div>
...
function jetpack_comments_more_info()
{
    ...
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/comments.jpg') ?>"
             alt="<?php esc_attr_e('Comments Screenshot', 'jetpack') ?>" width="300" height="150"/>
    </div>
...
function jetpack_carousel_more_info()
{
    ...
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/carousel.jpg') ?>"
             alt="<?php esc_attr_e('Gallery Carousel Screenshot', 'jetpack') ?>" width="300" height="188"/>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/custom-css.jpg') ?>"
             alt="<?php esc_attr_e('Custom CSS', 'jetpack') ?>" width="300" height="150"/>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/mobile-theme.jpg') ?>"
             alt="<?php esc_attr_e('Mobile Theme', 'jetpack') ?>" width="300" height="150"/>
    </div>
...
{ ?>
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/post-by-email.jpg') ?>"
             alt="<?php esc_attr_e('Post by Email', 'jetpack') ?>" width="300" height="115"/>
    </div>
    ...
    <p>&rarr; <a href="http://jetpack.com/support/post-by-email/"
                 target="_blank"><?php esc_html_e('More information on sending emails, attachments, and customizing your posts.', 'jetpack'); ?></a>
    </p>
...
{ ?>
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/tiled-gallery.jpg') ?>"
             alt="<?php esc_attr_e('Tiled Galleries', 'jetpack') ?>" width="300" height="150"/>
    </div>
    ...
    <p>
        <em><?php esc_html_e('Note: Images in tiled galleries require extra-special processing, so they will be served from WordPress.com\'s CDN even if the Photon module is disabled.', 'jetpack'); ?></em>
    </p>
    <?php
}
...
{ ?>
    ...
    <div class="jp-info-img">
        <a href="http://jetpack.com/support/likes/" target="_blank">
            <img class="jp-info-img"
                 src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/likes.jpg') ?>"
                 alt="<?php esc_attr_e('Likes', 'jetpack') ?>" width="323" height="69"/>
        </a>
    </div>
...
<?php endif; ?>
    <p>&rarr; <a href="http://jetpack.com/support/likes/"
                 target="_blank"><?php esc_html_e('More information on using Likes.', 'jetpack'); ?></a></p>
...
{ ?>
    ...
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/custom-content-types.jpg') ?>"
             alt="<?php esc_attr_e('Custom Content Type', 'jetpack') ?>" width="300" height="150"/>
    </div>
...
{ ?>
    ...
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/site-icon.png') ?>"
             alt="<?php esc_attr_e('Site Icon', 'jetpack') ?>" width="300" height="150"/>
    </div>
...
{ ?>
    ...
    <div class="jp-info-img">
        <img class="jp-info-img"
             src="<?php echo plugins_url(basename(dirname(dirname(__FILE__))) . '/images/screenshots/manage.jpg') ?>"
             alt="<?php esc_attr_e('Manage all of your WordPress sites, self-hosted or not, from WordPress.com', 'jetpack') ?>"
             width="300" height="150"/>
    </div>

    <p>
        <em><?php esc_html_e('Enabling Manage allows you to update your self-hosted WordPress sites along with any WordPress.com sites you have, all in one simple dashboard.', 'jetpack'); ?></em>
    </p>
    <p><strong><?php _e('Plugins', 'jetpack'); ?></strong><br/>
        <?php printf(__('Now you can update plugins, set plugins to automatically update, and activate or deactivate plugins on a per-site basis or in bulk from <a href="%s" target="_blank">wordpress.com/plugins</a>.', 'jetpack'), 'https://wordpress.com/plugins'); ?>
    </p>

    <p><strong><?php _e('Themes', 'jetpack'); ?></strong><br/>
        <?php printf(__('List your installed themes, search, and activate them from <a href="%s" target="_blank">wordpress.com/design</a>.', 'jetpack'), 'https://wordpress.com/design'); ?>
    </p>

    <p><strong><?php _e('Menus', 'jetpack'); ?></strong><br/>
        <?php printf(__('Create a new menu for your site, or edit existing menus from <a href="%s" target="_blank">wordpress.com/menus</a>.', 'jetpack'), 'https://wordpress.com/menus'); ?>
    </p>
...
{ ?>
    ...
    <p>
        <strong><?php esc_html_e('Your site is currently set to discourage search engines from indexing it so the sitemap will not be accessible.', 'jetpack'); ?></strong>
    </p>
<?php else :
...
<?php endif; ?>
    <p>&rarr; <a href="http://jetpack.com/support/sitemaps/"
                 target="_blank"><?php esc_html_e('More information on Sitemaps.', 'jetpack'); ?></a></p>
    <?php
}
