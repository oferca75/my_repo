...
<fieldset>
    ...
    <p>
        ...
        <?php _e('<code>Not detected</code>: May be installed, but cannot be automatically confirmed.', 'w3-total-cache'); ?>
        <br/>
...
<div id="w3tc-self-test">
    ...
    <ul>
        ...
        <li>
            ...
            <?php endif; ?>
            <span
                class="w3tc-self-test-hint"><?php _e('(required for Self-hosted (<acronym title="File Transfer Protocol">FTP</acronym>) <acronym title="Content Delivery Network">CDN</acronym> support)', 'w3-total-cache'); ?></span>
        </li>
        ...
        <li>
            ...
            <?php endif; ?>
            <span
                class="w3tc-self-test-hint"><?php _e('(required for Rackspace Cloud Files support)', 'w3-total-cache'); ?></span>
        </li>
        ...
        <li>
            ...
            <?php endif; ?>
            <span
                class="w3tc-self-test-hint"><?php _e('(required for Amazon S3, Amazon CloudFront, Rackspace CloudFiles support)', 'w3-total-cache'); ?></span>
        </li>
        ...
        <li>
            ...
            <?php endif; ?>
            <span
                class="w3tc-self-test-hint"><?php _e('(required for compression support)', 'w3-total-cache'); ?></span>
        </li>
        ...
        <li>
            ...
            <?php endif; ?>
            <span
                class="w3tc-self-test-hint"><?php _e('(required for HTML Tidy minifier suppport)', 'w3-total-cache'); ?></span>
        </li>
        ...
        <li>
            ...
            <?php endif; ?>
            <span
                class="w3tc-self-test-hint"><?php _e('(required for <acronym title="Content Delivery Network">CDN</acronym> support)', 'w3-total-cache'); ?></span>
        </li>
        ...
        <li>
            ...
            <?php endif; ?>
            <span
                class="w3tc-self-test-hint"><?php _e('(required for NetDNA / MaxCDN <acronym title="Content Delivery Network">CDN</acronym> purge support)', 'w3-total-cache'); ?></span>
        </li>
        ...
        if (w3_is_apache()):
            ...
            <li>
                ...
                <?php endif; ?>
                <span
                    class="w3tc-self-test-hint"><?php _e('(required for disk enhanced Page Cache and Browser Cache)', 'w3-total-cache'); ?></span>
            </li>
        <?php endforeach; ?>
        <?php endif; ?>
    </ul>
    ...
    <ul>
        ...
        <li>
            ...
            <?php if (w3_is_network()): ?>
                <code><?php _e('Yes', 'w3-total-cache'); ?>
                    (<?php echo(w3_is_subdomain_install() ? 'subdomain' : 'subdir'); ?>)</code>
            <?php else: ?>
