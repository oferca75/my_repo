...
<div class="wrap">
    <h1><?php echo esc_html($title); ?> <a href="link-add.php"
                                           class="page-title-action"><?php echo esc_html_x('Add New', 'link'); ?></a>
    </h1>
    ...
    <form name="<?php echo esc_attr($form_name); ?>" id="<?php echo esc_attr($form_name); ?>" method="post"
          action="link.php">
        <?php
        if (!empty($link_added)) {
            echo $link_added;
            ...
            <div id="post-body"
                ...
                <div id="post-body-content">
                    <div id="namediv" class="stuffbox">
                        ...
                        <div class="inside">
                            <input type="text" name="link_name" size="30" maxlength="255"
                                   value="<?php echo esc_attr($link->link_name); ?>" id="link_name"/>
                    ...
                    <div id="addressdiv" class="stuffbox">
                        ...
                        <div class="inside">
                            <input type="text" name="link_url" size="30" maxlength="255" class="code"
                                   value="<?php echo esc_attr($link->link_url); ?>" id="link_url"/>
                    ...
                    <div id="descriptiondiv" class="stuffbox">
                        ...
                        <div class="inside">
                            <input type="text" name="link_description" size="30" maxlength="255"
