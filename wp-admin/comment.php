    ...
    case 'spam'    :
        ...
        <div class="wrap">
            ...
            <div id="message" class="notice notice-warning"><p>
                    <strong><?php _e('Caution:'); ?></strong> <?php echo $caution_msg; ?></p></div>
            ...
            <table class="form-table comment-ays">
                ...
                <tr>
                    ...
                    <td class="comment-content">
                        ...
                        <p class="edit-comment"><a
                                href="<?php echo admin_url("comment.php?action=editcomment&amp;c={$comment->comment_ID}"); ?>"><?php esc_attr_e('Edit'); ?></a>
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <form action="comment.php" method="get" class="comment-ays-submit">
                ...
                <p>
                    ...
                    <a href="<?php echo admin_url('edit-comments.php'); ?>"
                       class="button-cancel"><?php esc_attr_e('Cancel'); ?></a>
                </p>
