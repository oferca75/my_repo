        ...
        <td>
            ...
            <select name="cloudflare_sec_lvl_new"
                ...
                <?php foreach ($cloudflare_seclvls as $cloudflare_seclvl_key => $cloudflare_seclvl_label): ?>
                    <option
                        value="<?php echo esc_attr($cloudflare_seclvl_key); ?>"<?php selected($cloudflare_seclvl, $cloudflare_seclvl_key); ?>><?php echo $cloudflare_seclvl_label; ?></option>
                <?php endforeach; ?>
            </select>
        </td>
    </tr>
        ...
        <td>
            ...
            <select name="cloudflare_async_new"
                ...
                <?php foreach ($cloudflare_rocket_loaders as $cloudflare_rocket_loader_key => $cloudflare_rocket_loader_label): ?>
                    <option
                        value="<?php echo $cloudflare_rocket_loader_key; ?>"<?php selected($cloudflare_rocket_loader, $cloudflare_rocket_loader_key); ?>><?php echo $cloudflare_rocket_loader_label; ?></option>
                <?php endforeach; ?>
            </select>
        </td>
    </tr>
        ...
        <td>
            ...
            <select name="cloudflare_minify_new"
                ...
                <?php foreach ($cloudflare_minifications as $cloudflare_minify_key => $cloudflare_minify_label): ?>
                    <option
                        value="<?php echo esc_attr($cloudflare_minify_key); ?>"<?php selected($cloudflare_minify, $cloudflare_minify_key); ?>><?php echo $cloudflare_minify_label; ?></option>
                <?php endforeach; ?>
            </select>
        </td>
    </tr>
        ...
        <td>
            ...
            <select name="cloudflare_devmode_new"
                ...
                <?php foreach ($cloudflare_devmodes as $cloudflare_devmode_key => $cloudflare_devmode_label): ?>
                    <option
                        value="<?php echo esc_attr($cloudflare_devmode_key); ?>"<?php selected($cloudflare_devmode, $cloudflare_devmode_key); ?>><?php echo $cloudflare_devmode_label; ?></option>
                <?php endforeach; ?>
            </select>
...
<p class="submit">
    ...
    <input id="cloudflare_purge_cache" class="button {nonce: '<?php echo wp_create_nonce('w3tc'); ?>'}" type="button"
           value="<?php _e('Purge cache', 'w3-total-cache'); ?>"<?php if (!$cloudflare_enabled): ?> disabled="disabled"<?php endif; ?> />
</p>
