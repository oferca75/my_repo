...
class WP_Customize_Theme_Control extends WP_Customize_Control
{
    ...
    <div class="theme active" tabindex="0" data-preview-url="<?php echo esc_attr($active_url); ?>"
        ...
        <# } else { #>
        <div class="theme" tabindex="0" data-preview-url="<?php echo esc_attr($preview_url); ?>"
             aria-describedby="{{ data.theme.id }}-action {{ data.theme.id }}-name">
            <# } #>
                        ...
                        <# } #>
                            ...
                            <# if ( data.theme.isActiveTheme ) { #>
                                <span class="more-details"
                                      id="{{ data.theme.id }}-action"><?php _e('Customize'); ?></span>
                                <# } else { #>
                                    <span class="more-details"
                                    ...
                                    <# } #>
                                        ...
                                        <div
                                            class="theme-author"><?php printf(__('By %s'), '{{ data.theme.author }}'); ?></div>
                                        ...
                                        <# if ( data.theme.isActiveTheme ) { #>
                                            ...
                                            <# } else { #>
                                                ...
                                                <div class="theme-actions">
                                                    <button type="button"
                                                            class="button theme-details"><?php _e('Theme Details'); ?></button>
                                                </div>
                                                <# } #>
        </div>
        <?php
