    ...
    render: function () {
        return (
            <WelcomeSection id="welcome__jetpack">
                ...
                <p className="welcome__callout welcome__jetpack--callout">Connect your Jetpack profile to improve
                    security, track stats, and grow traffic</p>
                { this.state.jetpackConfigured ?
                    ...
                    <div className='welcome__submit'>
                        <Button disabled={this.state.jetpackConnecting} onClick={ this.handleJetpackConnect }
                                primary>{ this.state.jetpackConnecting ? 'Connecting' : 'Connect' } to
                            WordPress.com</Button>
                ...
                <div className='jetpack_connect_info'>
                    ...
                    <p>Use Jetpack tools like Publicize, Sharing, Subscribing and Related Posts to increase traffic, and
                        onsite engagement.</p>
                </div>
                <div className='jetpack_connect_info'>
                    <h2>Increase Security and Site Speed</h2>
                    <img src={ `${ JPS.base_url }/img/feature-photon-sm.jpg` }/>
                    <p>Gain peace of mind with Protect, the tool that has blocked billions of login attacks on millions
                        of sites.</p>
                    <p>Photon utilizes the state-of-the-art WordPress.com content delivery network to load your gorgeous
                        images super fast optimized for any device, and it’s completely free.</p>
                </div>
            </WelcomeSection>
        );
    }
