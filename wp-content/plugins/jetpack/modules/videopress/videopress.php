...
class Jetpack_VideoPress
{
                ...
                <table id="menu" class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="blog_id">
                                <option
                                    value="0" <?php selected($options['blog_id'], 0); ?>> <?php esc_html_e('None', 'jetpack'); ?></option>
                                <?php foreach ($options['blogs'] as $blog) : ?>
                                    <option
                                        value="<?php echo absint($blog['blog_id']); ?>" <?php selected($options['blog_id'], $blog['blog_id']); ?>><?php echo esc_html($blog['name']); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="radio" name="videopress-access"
                                          value="" <?php checked('', $options['access']); ?> />
                                <?php _e('Do not allow other users to access my VideoPress library', 'jetpack'); ?>
                            </label><br/>
                            <label><input type="radio" name="videopress-access"
                                          value="read" <?php checked('read', $options['access']); ?> />
                                <?php _e('Allow users to access my videos', 'jetpack'); ?></label><br/>
                            <label><input type="radio" name="videopress-access"
                                          value="edit" <?php checked('edit', $options['access']); ?> />
                                <?php _e('Allow users to access and edit my videos', 'jetpack'); ?></label><br/>
                            <label><input type="radio" name="videopress-access"
                                          value="delete" <?php checked('delete', $options['access']); ?> />
                                <?php _e('Allow users to access, edit, and delete my videos', 'jetpack'); ?>
                            </label><br/><br/>

                            <label><input type="checkbox" name="videopress-upload"
                                          value="1" <?php checked($options['allow-upload']); ?> />
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" name="videopress-freedom"
                                          id="videopress-freedom" <?php checked($options['freedom']); ?> />
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="checkbox" name="videopress-hd"
                                          id="videopress-hd" <?php checked($options['hd']); ?> />
    ...
    function admin_menu_library()
    {
        ...
        <div class="wrap" style="max-width: 600px;">
            ...
            <p class="hide-if-no-js"><a href="#" id="videopress-browse"
                                        class="button"><?php _e('Browse Your VideoPress Library', 'jetpack'); ?></a></p>
    ...
    function print_media_templates()
    {
            ...
            <# if ( data.vp_ogg_url ) { #>
                ...
                <# } #>
                    ...
                    <label class="setting vp-setting">
                        ...
                        <input class="vp-checkbox" type="checkbox"
                        <# if ( '1' === data.vp_share ) { #>checked
                            <# } #>
                                <# if ( ! data.can.save ) { #>disabled
                                    <# } #> />
                                        ...
                                        <input class="vp-checkbox-text" type="text" value="{{ data.vp_share }}"
                                               data-setting="vp_share" style="display:none;"/>
                    </label>
                    ...
                    <label class="setting vp-setting">
                        ...
                        <input class="vp-radio" type="radio" name="vp-radio-group"
                               id="vp-rating-<?php echo sanitize_html_class($value); ?>"
                        ...
                        <# if ( '<?php echo esc_attr($value); ?>' === data.vp_rating ) { #>checked
                            <# } #>
                                <# if ( ! data.can.save ) { #>disabled
                                    <# } #> />
                                        <label
                                            for="vp-rating-<?php echo sanitize_html_class($value); ?>"><?php echo esc_html($label); ?></label>
                                        <?php endforeach; ?>

                                        <input class="vp-radio-text" type="text" value="{{ data.vp_rating }}"
                                               data-setting="vp_rating" style="display:none;"/>
                    </label>

                    <label class="setting vp-setting">
                        <span><?php _e('Shortcode', 'jetpack'); ?></span>
                        <input type="text" value="[wpvideo {{ data.vp_guid }}]" onclick="this.focus();this.select();"
                               readonly/>
                    </label>
                    ...
                    <label class="setting vp-setting vp-preview">
                        ...
                        <# if ( ! data.vp_thumbnail_url ) { #>
                            <span
                                class="videopress-preview-unavailable"><?php esc_html_e('The preview is unavailable while this video is being processed.', 'jetpack'); ?></span>
                            <# } else { #>
                                <a href="#" class="videopress-preview" id="videopress-thumbnail-{{ data.vp_guid }}"
                                   data-videopress-guid="{{ data.vp_guid }}"><img
                                        src="{{ data.vp_thumbnail_url }}"/></a>
                                <# } #>
                    </label>
        </script>
        ...
        <script type="text/html" id="tmpl-videopress-uploader">
            ...
            <form class="videopress-upload-form" action="" method="post" target="videopress_upload_frame"
