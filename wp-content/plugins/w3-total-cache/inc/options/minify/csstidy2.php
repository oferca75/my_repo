...
<tr>
    <th><label
            for="minify_csstidy_options_template"><?php w3_e_config_label('minify.csstidy.options.template') ?></label>
    </th>
    <td>
        <select id="minify_csstidy_options_template" class="css_enabled" name="minify.csstidy.options.template"
            ...
            <?php foreach ($csstidy_templates as $csstidy_template_key => $csstidy_template_name): ?>
                <option
                    value="<?php echo esc_attr($csstidy_template_key); ?>" <?php selected($csstidy_template, $csstidy_template_key); ?>><?php echo $csstidy_template_name; ?></option>
            <?php endforeach; ?>
        </select>
    </td>
</tr>
<tr>
    <th><label
            for="minify_csstidy_options_optimise_shorthands"><?php w3_e_config_label('minify.csstidy.options.optimise_shorthands') ?></label>
    </th>
    <td>
        <select id="minify_csstidy_options_optimise_shorthands" class="css_enabled"
            ...
            <?php foreach ($optimise_shorthands_values as $optimise_shorthands_key => $optimise_shorthands_name): ?>
                <option
                    value="<?php echo esc_attr($optimise_shorthands_key); ?>" <?php selected($optimise_shorthands, $optimise_shorthands_key); ?>><?php echo $optimise_shorthands_name; ?></option>
            <?php endforeach; ?>
        </select>
    </td>
</tr>
<tr>
    <th><label
            for="minify_csstidy_options_case_properties"><?php w3_e_config_label('minify.csstidy.options.case_properties') ?></label>
    </th>
    <td>
        <select id="minify_csstidy_options_case_properties" class="css_enabled"
            ...
            <?php foreach ($case_properties_values as $case_properties_key => $case_properties_name): ?>
                <option
                    value="<?php echo esc_attr($case_properties_key); ?>" <?php selected($case_properties, $case_properties_key); ?>><?php echo $case_properties_name; ?></option>
            <?php endforeach; ?>
        </select>
    </td>
</tr>
<tr>
    <th><label
            for="minify_csstidy_options_merge_selectors"><?php w3_e_config_label('minify.csstidy.options.merge_selectors') ?></label>
    </th>
    <td>
        <select id="minify_csstidy_options_merge_selectors" class="css_enabled"
            ...
            <?php foreach ($merge_selectors_values as $merge_selectors_key => $merge_selectors_name): ?>
                <option
                    value="<?php echo esc_attr($merge_selectors_key); ?>" <?php selected($merge_selectors, $merge_selectors_key); ?>><?php echo $merge_selectors_name; ?></option>
            <?php endforeach; ?>
        </select>
    </td>
</tr>
