                            ...
                            <div class="inside">
                                <div id="comment-link-box">
                                    ...
                                    <span id="sample-permalink"><a
                                            href="<?php echo $comment_link; ?>"><?php echo $comment_link; ?></a></span>
                                </div>
                            </div>
                        <?php endif; ?>
                                ...
                                <fieldset>
                                    ...
                                    <table class="form-table editcomment">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="newcomment_author" size="30"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="newcomment_author_email" size="30"
                                        ...
                                        <tr>
                                            <td class="first"><label
                                                    for="newcomment_author_url"><?php _e('URL:'); ?></label></td>
                                            <td>
                                                <input type="text" id="newcomment_author_url"
                                        ...
                                        <div id="misc-publishing-actions">
                                            ...
                                            <div class="misc-pub-section curtime misc-pub-curtime">
                                                ...
                                                <fieldset id='timestampdiv' class='hide-if-js'>
                                                    <legend
                                                        class="screen-reader-text"><?php _e('Date and time'); ?></legend>
