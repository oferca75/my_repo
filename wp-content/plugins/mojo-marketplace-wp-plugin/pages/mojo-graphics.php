                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-8">
                                <ol class="breadcrumb">
                                    ...
                                    <?php if (isset($_GET['items']) && $type !== 'graphics') : ?>
                                        <li>
                                            <a href="<?php echo esc_url(add_query_arg(array('page' => 'mojo-' . $type), admin_url('admin.php'))); ?>">WordPress <?php echo ucfirst($type); ?></a>
                                        </li>
                                    <?php endif; ?>

                                    <?php if (isset($_GET['items']) && $type == 'graphics') : ?>
                                        <li>
                                            <a href="<?php echo esc_url(add_query_arg(array('page' => 'mojo-' . $type), admin_url('admin.php'))); ?>"><?php echo ucfirst($type); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php
                                    if (isset($_GET['items'])) {
                                            ...
                                            <div class="text-center info-box">
                                                ...
                                                <div class="btn-group-vertical" role="group">
                                                    ...
                                                    <a href="<?php echo mm_build_link(add_query_arg(array('item_id' => $item->id), 'https://www.mojomarketplace.com/cart'), array('utm_medium' => 'plugin_admin', 'utm_content' => 'buy_now_list')); ?>"
                                                       ...
                                                       data-view="graphics_list">Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
