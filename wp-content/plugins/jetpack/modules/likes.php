...
class Jetpack_Likes
{
    ...
    function meta_box_content($post)
    {
        ...
        <p>
            <label for="wpl_enable_post_likes">
                <input type="checkbox" name="wpl_enable_post_likes" id="wpl_enable_post_likes"
    ...
    function sharing_meta_box_content($post)
    {
        ...
        <p>
            <label for="wpl_enable_post_sharing">
                <input type="checkbox" name="wpl_enable_post_sharing" id="wpl_enable_post_sharing"
    ...
    function admin_discussion_likes_settings_field()
    {
        ...
        ?>
        <label><input type="checkbox" id="social_notifications_like" name="social_notifications_like"
                      value="1" <?php checked($like); ?> /> <?php esc_html_e('Someone likes one of my posts', 'jetpack'); ?>
        </label>
        <?php
    }
    ...
    { ?>
        <tr>
            ...
            <td>
                <div>
                    <label>
                        <input type="radio" class="code" name="wpl_default"
                               value="on" <?php checked($this->is_enabled_sitewide(), true); ?> />
                ...
                <div>
                    <label>
                        <input type="radio" class="code" name="wpl_default"
                               value="off" <?php checked($this->is_enabled_sitewide(), false); ?> />
        ...
        <tr>
            ...
            <td>
                <div>
                    <label>
                        <input type="radio" class="code" name="jetpack_reblogs_enabled"
                               value="on" <?php checked($this->reblogs_enabled_sitewide(), true); ?> />
                ...
                <div>
                    <label>
                        <input type="radio" class="code" name="jetpack_reblogs_enabled"
                               value="off" <?php checked($this->reblogs_enabled_sitewide(), false); ?> />
        ...
        <tr>
            ...
            <td>
                <div>
                    <label>
                        <input type="checkbox" class="code" name="jetpack_comment_likes_enabled"
                               value="1" <?php checked($this->is_comments_enabled(), true); ?> />
        ...
        <form method="post" action="">
            ...
            <p class="submit">
                <input type="submit" name="submit" class="button-primary"
                       value="<?php esc_attr_e('Save Changes', 'jetpack'); ?>"/>
            </p>
    ...
    function load_admin_css()
    {
        ...
        <style type="text/css">
            ...
            .fixed .column-likes .post-com-count::after {
                border: none !important;
            }

            .fixed .column-likes .post-com-count:hover {
    ...
    <?php else : // @todo Remove when 4.3 is minimum ?>
        <style type="text/css">
            ...
            .fixed .column-likes .comment-count {
                background-color: #bbb;
            }

            .fixed .column-likes .comment-count:hover {
                background-color: #2ea2cc;
            }

            .fixed .column-likes .vers img {
                display: none;
            }
    ...
    function likes_edit_column($column_name, $post_id)
    {
        if ('likes' == $column_name) {
            ...
            <a title="" data-post-id="<?php echo (int)$post_id; ?>" class="post-com-count post-like-count"
               id="post-like-count-<?php echo (int)$post_id; ?>" data-blog-id="<?php echo (int)$blog_id; ?>"
               href="<?php echo esc_url($permalink); ?>#like-<?php echo (int)$post_id; ?>">
    ...
    function likes_master()
    {
        ...
        ?>
        <iframe src='<?php echo $src; ?>' scrolling='no' id='likes-master' name='likes-master'
                style='display:none;'></iframe>
        <div id='likes-other-gravatars'>
            <div class="likes-text"><?php echo $likersText; ?></div>
