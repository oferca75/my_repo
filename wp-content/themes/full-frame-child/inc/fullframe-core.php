    ...
    function fullframe_content_nav($nav_id)
    {
        ...
        <nav role="navigation" id="<?php echo esc_attr($nav_id); ?>">
            ...
            if ('numeric' == $pagination_type && function_exists('wp_pagenavi')) {
                ...
                <div
                    class="nav-previous"><?php next_posts_link(__('<span class="meta-nav">&larr;</span> Older posts', 'full-frame')); ?></div>
                <div
                    class="nav-next"><?php previous_posts_link(__('Newer posts <span class="meta-nav">&rarr;</span>', 'full-frame')); ?></div>
                <?php
            } ?>
        </nav><!-- #nav -->
        <?php
