    ...
    public function html()
    {
        ...
        <head>
            <meta http-equiv="Content-Type"
                  content="<?php echo esc_attr(get_bloginfo('html_type')); ?>; charset=<?php echo esc_attr(get_option('blog_charset')); ?>"/>
        ...
        <div id="scanbar" class="scan">
            <form method="GET">
                ...
                <input type="url" name="u" id="url-scan" class="scan-url" value=""
                       placeholder="<?php esc_attr_e('Enter a URL to scan') ?>"/>
                <input type="submit" name="url-scan-submit" id="url-scan-submit" class="scan-submit"
                       value="<?php esc_attr_e('Scan') ?>"/>
            </form>
        </div>
            ...
            <div class="wrapper">
                <div class="editor-wrapper">
                    ...
                    <div id="app-container" class="editor">
                        <span id="title-container-label" class="post-title-placeholder"
                              aria-hidden="true"><?php _e('Post title'); ?></span>
                        <h2 id="title-container" class="post-title" contenteditable="true" spellcheck="true"
                            aria-label="<?php esc_attr_e('Post title'); ?>"
                            tabindex="0"><?php echo esc_html($post_title); ?></h2>
                    ...
                    <div class="post-options">
                        ...
                        <?php if ($supports_formats) : ?>
                            <button type="button" class="button-link post-option">
                                ...
                                <span class="post-option-contents"
                                      id="post-option-post-format"><?php echo esc_html(get_post_format_string($post_format)); ?></span>
                        ...
                        <div class="setting-modal is-off-screen is-hidden">
                            <button type="button" class="button-link modal-close">
                                ...
                                <span class="setting-title"
                                      aria-hidden="true"><?php _ex('Format', 'post format'); ?></span>
                    ...
                    <div class="split-button">
                        <div class="split-button-head">
                            <button type="button" class="publish-button split-button-primary" aria-live="polite">
                                <span
                                    class="publish"><?php echo (current_user_can('publish_posts')) ? __('Publish') : __('Submit for Review'); ?></span>
                                <span class="saving-draft"><?php _e('Saving&hellip;'); ?></span>
                            </button>
                            <button type="button" class="split-button-toggle" aria-haspopup="true"
                                    aria-expanded="false">
                        ...
                        <ul class="split-button-body">
                            <li>
                                <button type="button"
                                        class="button-link draft-button split-button-option"><?php _e('Save Draft'); ?></button>
                            </li>
                            <li>
                                <button type="button"
                                        class="button-link standard-editor-button split-button-option"><?php _e('Standard Editor'); ?></button>
                            </li>
                            <li>
                                <button type="button"
                                        class="button-link preview-button split-button-option"><?php _e('Preview'); ?></button>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="post-formats-select">
                    <fieldset>
                        ...
                        <input type="radio" name="post_format" class="post-format" id="post-format-0"
                               value="0" <?php checked($post_format, '0'); ?> />
                        <label for="post-format-0"
                        ...
                        foreach ($post_formats[0] as $format) {
                            ...
                            <input type="radio" name="post_format" class="post-format"
                                   ...
                                   value="<?php echo $attr_format; ?>" <?php checked($post_format, $format); ?> />
    ...
    public function categories_html($post)
    {
        ...
        if (current_user_can($taxonomy->cap->edit_terms)) {
            ...
            <button type="button" class="add-cat-toggle button-link" aria-expanded="false">
                <span class="dashicons dashicons-plus"></span><span
                    class="screen-reader-text"><?php _e('Toggle add category'); ?></span>
            </button>
            <div class="add-category is-hidden">
                <label class="screen-reader-text"
                       for="new-category"><?php echo $taxonomy->labels->add_new_item; ?></label>
                <input type="text" id="new-category" class="add-category-name"
                       placeholder="<?php echo esc_attr($taxonomy->labels->new_item_name); ?>" value=""
                       aria-required="true">
                <label class="screen-reader-text"
                       for="new-category-parent"><?php echo $taxonomy->labels->parent_item_colon; ?></label>
        ...
        <div class="categories-search-wrapper">
            ...
            <label for="categories-search">
                <span class="dashicons dashicons-search"></span><span
                    class="screen-reader-text"><?php _e('Search categories'); ?></span>
            </label>
        </div>
    ...
    public function tags_html($post)
    {
        ...
        if ($user_can_assign_terms) {
            ...
            <button type="button" class="button-link tagcloud-link"
                    id="link-post_tag"><?php echo $taxonomy->labels->choose_from_most_used; ?></button>
            <?php
        }
    }
}
